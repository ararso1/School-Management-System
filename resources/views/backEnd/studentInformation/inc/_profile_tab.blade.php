    ...
    <div>
            ...
            @if (is_show('fathers_photo'))
                <div class="mr-20 mt-20">
                    <img class="student-meta-img img-100"
                         src="{{ uploadedAsset(@$student_detail->parents->fathers_photo, 'public/uploads/staff/demo/father.png') }}"
                         alt="{{ @$student_detail->parents->fathers_name }}">
        ...
        <div class="d-flex">
            @if (is_show('mothers_photo'))
                <div class="mr-20 mt-20">
                    <img class="student-meta-img img-100"
                         src="{{ uploadedAsset(@$student_detail->parents->mothers_photo, 'public/uploads/staff/demo/mother.jpg') }}"
                         alt="{{ @$student_detail->parents->mothers_name }}">
                </div>
            @endif
            <div class="w-100">
                <div class="single-info">
        ...
        <div class="d-flex">
            @if (is_show('guardians_photo'))
                <div class="mr-20 mt-20">
                    <img class="student-meta-img img-100"
                         src="{{ uploadedAsset(@$student_detail->parents->guardians_photo, 'public/uploads/staff/demo/guardian.jpg') }}"
                         alt="{{ @$student_detail->parents->guardians_name }}">
