                                                        ...
                                                        <div class="card_text_left vId">
                                                            ...
                                                            @if($role_id==2 && moduleStatusCheck('University'))
                                                                @if($id_card->un_session==1)
                                                                    <div id="vSession">
                                                                        <h3 style="line-height:1.02; margin-top: 0; margin-bottom: 0; font-size:10px;">@lang('university::un.session') : @foreach($staff_student->studentRecords as $record)
                                                                ...
                                                                @if($id_card->un_faculty==1)
                                                                    <div id="vFaculty">
                                                                        <h3 style="line-height:1.02; margin-top: 0; margin-bottom: 0; font-size:10px;">@lang('university::un.faculty') : @foreach($staff_student->studentRecords as $record)
                                                                            {{ $record->unFaculty->name}} 
                                                                            {{ ($loop->iteration > 1 && !$loop->last) ? ',' :'' }}
                                                                            @endforeach</h3>
                                                                    </div>
                                                                ...
                                                                @if($id_card->un_department==1)
                                                                    <div id="vDepartment">
                                                                        <h3 style="line-height:1.02; margin-top: 0; margin-bottom: 0; font-size:10px;">@lang('university::un.department') : @foreach($staff_student->studentRecords as $record)
                                                                            {{ $record->unDepartment->name}} 
                                                                            {{ ($loop->iteration > 1 && !$loop->last) ? ',' :'' }}
                                                                            @endforeach</h3>
                                                                    </div>
                                                                ...
                                                                @if($id_card->un_academic==1)
                                                                    <div id="vAcademic">
                                                                        <h3 style="line-height:1.02; margin-top: 0; margin-bottom: 0; font-size:10px;">@lang('university::un.academic') : @foreach($staff_student->studentRecords as $record)
                                                                            {{ $record->unAcademic->name}} 
                                                                            {{ ($loop->iteration > 1 && !$loop->last) ? ',' :'' }}
                                                                            @endforeach</h3>
                                                                    </div>
                                                                ...
                                                                @if($id_card->un_semester==1)
                                                                    <div id="vSemester">
                                                                        <h3 style="line-height:1.02; margin-top: 0; margin-bottom: 0; font-size:10px;">@lang('university::un.semester') : @foreach($staff_student->studentRecords as $record)
                                                                            {{ $record->unSemester->name}} 
                                                                            {{ ($loop->iteration > 1 && !$loop->last) ? ',' :'' }}
                                                                            @endforeach</h3>
                                                                    </div>
