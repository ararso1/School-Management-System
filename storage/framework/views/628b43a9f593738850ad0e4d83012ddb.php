...
<?php echo app('translator')->get('common.view_result'); ?>
        ...
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
             ...
             <a href="#"><?php echo app('translator')->get('exam.online_exam'); ?></a>
                <a href="<?php echo e(route('student_view_result')); ?>"><?php echo app('translator')->get('common.view_result'); ?></a>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-30"><?php echo app('translator')->get('exam.online_exam'); ?></h3>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="">
                                    <div class="row  pl-10">
                                        ...
                                        <div class="col-lg-5 mt-20">
                                            <p class="mb-2"><strong><?php echo app('translator')->get('common.date'); ?> & <?php echo app('translator')->get('common.time'); ?>: </strong><?php echo e(dateConvert(@$online_exam->date)); ?> <?php echo e((@$online_exam->end_time)); ?></p>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\backEnd\studentPanel\view_online_question.blade.php ENDPATH**/ ?>