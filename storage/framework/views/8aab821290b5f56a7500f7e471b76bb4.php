          ...
          <td class="border-0 full_name_header">
            ...
            <tr>
                ...
                <th> 
                    ...
                    <?php elseif(count($payrollDetails->payrollPayments) > 0): ?>
            ...
            <tr>
                ...
                <th><?php if(isset($payrollDetails)): ?><?php echo e(currency_format($payrollDetails->payrollPayments->sum('amount'))); ?> <?php endif; ?></th>
            </tr>
...
</html><?php /**PATH C:\xampp\htdocs\resources\views/backEnd/humanResource/payroll/payslip_print.blade.php ENDPATH**/ ?>