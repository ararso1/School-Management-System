<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('chat::chat.new_chat'); ?>
                ...
                <div class="col-12">
                    <div class="chat_main_wrapper">
                        ...
                        <div class="chat_flow_list_wrapper white-box mb-3">
                            <div class="box_header">
                                <div class="main-title">
                                    <h3 class="m-0"><?php echo app('translator')->get('chat::chat.list'); ?></h3>
                                </div>
                            </div>
                            <!-- chat_list  -->
                                        ...
                                        <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <li style="list-style: none">
                                                <div class="single_list d-flex align-items-center">
                                                    ...
                                                    <a style="padding: 7px 40px 7px 25px;" href="<?php echo e(route('chat.index', $user->id)); ?>" class="primary-btn radius_30px fix-gr-bg"><?php echo app('translator')->get('chat::chat.start'); ?></a>
                                                </div>
                                            </li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                            <p><?php echo app('translator')->get('chat::chat.no_user_found_to_chat'); ?>!</p>
                                        <?php endif; ?>
                                    </ul>
                                </div>
                            </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Modules/Chat\Resources/views/new-chat.blade.php ENDPATH**/ ?>