                ...
                <div class="invoice_wrapper">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="addressleft_text">
                                                                ...
                                                                <p><span><strong><?php echo app('translator')->get('student.student_name'); ?> </span> <span class="nowrap">: <?php echo e($invoice->studentInfo->full_name); ?></span> </strong></p>
                                                                <p><span><?php echo app('translator')->get('student.class_section'); ?></span> <span>: <?php echo e($invoice->recordDetail->class->class_name); ?> (<?php echo e($invoice->recordDetail->section->section_name); ?>)</span> </p>
                                                                <p><span><?php echo app('translator')->get('student.roll_no'); ?></span> <span>: <?php echo e($invoice->recordDetail->roll_no); ?></span> </p>
                                                                <p><span><?php echo app('translator')->get('student.admission_no'); ?></span> <span>: <?php echo e($invoice->studentInfo->admission_no); ?></span> </p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                ...
                                                <table class="mb_30" style="margin-left: auto; margin-right: 0;">
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <?php
                                                                    $subTotal = $invoice->invoiceDetails->sum('sub_total');
                                                                    $paidAmount = $invoice->invoiceDetails->sum('paid_amount');
                                                                    $paymentStatus = $subTotal - $paidAmount;
                                                                ?>
                                                                <div class="addressright_text">
                                                                    <p><span><strong><?php echo app('translator')->get('fees.invoice_number'); ?></span> <span>: <?php echo e($invoice->invoice_id); ?></span> </strong></p>
                                                                    <p><span><?php echo app('translator')->get('fees.create_date'); ?> </span> <span>: <?php echo e(dateConvert($invoice->create_date)); ?></span> </p>
                                                                    <p><span><?php echo app('translator')->get('fees.due_date'); ?> </span> <span>: <?php echo e(dateConvert($invoice->due_date)); ?></span> </p>
                                                                    <p>
                                                                        <span>
                    ...
                    <table class="table border_table mb_30 description_table" >
                        ...
                        <tr>
                            <td colspan="5"></td>
                            <td colspan="2">
                                <p class="total_count"><span><?php echo app('translator')->get('accounts.grand_total'); ?></span> <span><?php echo e(currency_format($grand_total)); ?></span></p>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="5"></td>
...
</html><?php /**PATH C:\xampp\htdocs\Modules\BulkPrint\Resources\views\feesInvoice\feesInvoiceBulkPrint.blade.php ENDPATH**/ ?>