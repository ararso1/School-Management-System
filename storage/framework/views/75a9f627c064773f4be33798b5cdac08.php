...
<head>
    ...
    <title><?php echo app('translator')->get('alumni::al.certificate'); ?></title>
    <style>
...
<body id="pdf">
    ...
    <table style="width: 100%;padding: 30px;">
        <tr>
            <td style="font-size: 16px; font-weight:700;width: 45%;text-transform: uppercase;"><?php echo e(generalSetting()->school_name); ?></td>
            <td style="width: 15%;text-align: center;">
                <div style=" margin-left: auto;">
                    <img src="<?php echo e(asset(generalSetting()->logo)); ?>" alt="" style="width: 100%;height: 100%;">
                </div>
            </td>
        ...
        <tr>
            <td style="text-align: center; font-size: 16px; font-weight: 500;line-height: 1.3;"><?php echo $body; ?></td>
            <td></td>
            <td style="text-align: center; font-size: 16px; font-weight: 500;line-height: 1.3;"><?php echo $body_two; ?></td>
        </tr>
        ...
        <tr>
            ...
            <td style="text-align: center; font-size: 16x; font-weight: 600;line-height: 1.3;">
                ...
                <div style="text-align: right;"><?php echo e(@$certificateNumber); ?></div>
            </td>
        </tr>
    </table>
...
</html><?php /**PATH C:\xampp\htdocs\resources\views\backEnd\admin\generate_arabic_certificate.blade.php ENDPATH**/ ?>