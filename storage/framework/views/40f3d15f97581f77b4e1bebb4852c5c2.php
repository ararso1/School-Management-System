                        ...
                        <div class="row">
                            <div class="col-lg-4 no-gutters">
                                <div class="main-title">
                                    <h3 class="mb-15"><?php echo app('translator')->get('study.syllabus_list'); ?></h3>
                                </div>
                            </div>
                        </div>
...
<?php $component->withAttributes([]); ?>
                                    <table id="table_id" class="table syllabus-data-table" cellspacing="0" width="100%">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"><?php echo app('translator')->get('study.delete_syllabus'); ?></h4>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\backEnd\teacher\syllabusList.blade.php ENDPATH**/ ?>