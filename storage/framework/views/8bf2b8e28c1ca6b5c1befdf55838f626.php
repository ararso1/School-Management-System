                                    ...
                                    <div class="col-lg-6">
                                        <div class="primary_input">
                                            ...
                                            <span class="text-danger" >
                                                <?php echo e($errors->first('exam_marks')); ?>
                            ...
                            <table class="table" id="productTable">
                                ...
                                <?php $i++; $totalMark += $row->exam_mark; ?>
                                  <tr id="row1" class="mt-40">
                                    ...
                                    <td  class="border-top">
                                         <button class="primary-btn icon-only fix-gr-bg" id="firstMarkRow" type="button" id="<?php echo e($i != 1? 'removeMark':''); ?>">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\backEnd\examination\examEdit.blade.php ENDPATH**/ ?>