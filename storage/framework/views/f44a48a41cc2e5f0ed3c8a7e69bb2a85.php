    ...
    <div class="col-lg-3">
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php else: ?>
                    <?php if(userPermission('student-leave-store')): ?>
                ...
                <div class="white-box">
                    <div class="main-title">
                        <h3 class="mb-15"><?php if(isset($apply_leave)): ?>
                    ...
                    <div class="add-visitor">
                        <div class="row no-gutters input-right-icon">
                            ...
                            <div class="col">
                                <div class="primary_input">
                                    <label class="primary_input_label" for=""><?php echo app('translator')->get('leave.apply_date'); ?><span class="text-danger"> *</span> </label>
                                    <input class="primary_input_field  primary_input_field date form-control form-control<?php echo e($errors->has('apply_date') ? ' is-invalid' : ''); ?>" id="apply_date" type="text"
                        ...
                        <div class="row mt-25">
                            <div class="col-lg-12">
                                <select class="primary_select  form-control<?php echo e($errors->has('leave_type') ? ' is-invalid' : ''); ?>" name="leave_type">
                                    <option data-display="<?php echo app('translator')->get('leave.leave_type'); ?> *" value=""><?php echo app('translator')->get('leave.leave_type'); ?> *</option>
                                    <?php $__currentLoopData = $leave_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leave_define): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($leave_define->id); ?>" <?php echo e(isset($apply_leave)? ($apply_leave->leave_define_id == $leave_define->id? 'selected':''):''); ?>><?php echo e($leave_define->leaveType->type); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                        ...
                        <div class="row no-gutters input-right-icon mt-25">
                            <div class="col">
                                <div class="primary_input">
                                    <label class="primary_input_label" for=""><?php echo app('translator')->get('leave.leave_from'); ?><span class="text-danger"> *</span> </label>
                                    <input class="primary_input_field  primary_input_field date form-control form-control<?php echo e($errors->has('leave_from') ? ' is-invalid' : ''); ?>" id="startDate" type="text"
                        ...
                        <div class="row no-gutters input-right-icon mt-25">
                            <div class="col">
                                <div class="primary_input">
                                    <label class="primary_input_label" for=""><?php echo app('translator')->get('leave.leave_to'); ?><span class="text-danger"> *</span> </label>
                                    <input class="primary_input_field  primary_input_field date form-control form-control<?php echo e($errors->has('leave_to') ? ' is-invalid' : ''); ?>" id="leave_to" type="text" name="leave_to" value="<?php echo e(isset($apply_leave)? date('m/d/Y', strtotime($apply_leave->leave_to)):date('m/d/Y')); ?>">
                        ...
                        <div class="row mt-25">
                            <div class="col-lg-12">
                                <div class="primary_input">
                                    <label class="primary_input_label" for=""><?php echo app('translator')->get('leave.reason'); ?></label>
                        ...
                        <div class="row no-gutters input-right-icon mt-25">
                            ...
                            <div class="col-auto">
                                <button class="primary-btn-small-input" type="button">
                                    <label class="primary-btn small fix-gr-bg" for="attach_file"><?php echo app('translator')->get('common.browse'); ?></label>
                                    ...
                                    <td>
                                        <div class="dropdown CRM_dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a data-modal-size="modal-lg" title="View Leave Details" class="dropdown-item modalLink" href="<?php echo e(route('view-leave-details-apply', $apply_leave->id)); ?>"><?php echo app('translator')->get('common.view'); ?></a>
        
                                                <?php endif; ?>
                                                <?php if($apply_leave->approve_status == 'P'): ?>
                                                <?php if(userPermission('student-leave-edit')): ?>
                                                ...
                                                <?php if($apply_leave->file != ""): ?>
                                                    <a class="dropdown-item" href="<?php echo e(url(@$apply_leave->file)); ?>" download>
                                                        <?php echo app('translator')->get('leave.download'); ?> 
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\backEnd\student_leave\apply_leave.blade.php ENDPATH**/ ?>