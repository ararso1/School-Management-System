...
<head>
    ...
    <title><?php echo app('translator')->get('reports.progress_card_report'); ?></title>
    <style>
    ...
    <div class="invoice_wrapper">
                            ...
                            <div class="<?php echo e((resultPrintStatus('header'))? "logo_img": "logo_img custom_result_print"); ?>">
                                ...
                                <?php if(resultPrintStatus('image')): ?>
                                    <div class="profile_thumb">
                                        <img src="<?php echo e(file_exists(@$student_detail->studentDetail->student_photo) ? asset($student_detail->studentDetail->student_photo) : asset('public/uploads/staff/demo/staff.jpg')); ?>" alt="<?php echo e($student_detail->studentDetail->full_name); ?>" height="100" width="100">
                                    </div>
                                <?php endif; ?>
                            </div>
                        </td>
        ...
        <div class="<?php echo e((resultPrintStatus('body'))? "meritTableBody": "meritTableBodyCustomReport"); ?>">
            ...
            <div class="student_name_highlight" style="text-align: center; margin-bottom: 20px;">
                <h3> <span style="border-bottom: 3px double; font-size: 20px; "><?php echo app('translator')->get('reports.progress_report'); ?></span></h3>
            </div>
                ...
                <table class="table border_table gray_header_table max-width-400 ml_auto margin-auto report_table" style="<?php if(resultPrintStatus('vertical_boarder')): ?> margin-top: 20px;  <?php endif; ?> margin-bottom: 20px;">
                    <tbody>
                    <tr>
                    ...
                    <?php if(@generalSetting()->result_type != 'mark'): ?>
                        ...
                        <tr>
                            ...
                            <?php else: ?>
                                <td colspan="<?php echo e($colspan / $col_for_result + 9); ?>">
                                    <?php echo e(number_format(termWiseFullMark($assinged_exam_types,$student_id, $academic_id),2,'.','')); ?>
                        ...
                        <tr>
                            ...
                            <?php else: ?>
                                <td colspan="<?php echo e($colspan / $col_for_result + 9); ?>">
                                    <?php echo e(gradeName(number_format(termWiseFullMark($assinged_exam_types,$student_id, $academic_id),2,'.',''))); ?>
                        ...
                        <tr>
                            ...
                            <?php else: ?>
                                ...
                                <td colspan="<?php echo e($colspan / $col_for_result + 9); ?>">
                                    <?php echo e(remarks(number_format(termWiseFullMark($assinged_exam_types,$student_id, $academic_id),2,'.',''), $academic_id)); ?>
...
</html><?php /**PATH C:\xampp\htdocs\resources\views\backEnd\reports\progress_card_report_print.blade.php ENDPATH**/ ?>