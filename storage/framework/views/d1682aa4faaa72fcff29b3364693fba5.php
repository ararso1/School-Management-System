...
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('teacherEvaluation.teacher_approved_evaluation_report'); ?>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('mainContent'); ?>
    <section class="sms-breadcrumb mb-20">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1><?php echo app('translator')->get('teacherEvaluation.teacher_approved_evaluation_report'); ?></h1>
                <div class="bc-pages">
                    ...
                    <a href="#"><?php echo app('translator')->get('teacherEvaluation.teacher_approved_evaluation_report'); ?></a>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-12 student-details up_admin_visitor">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="row mb-40">
                                <div class="col-lg-12">
                                    <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'teacher-approved-evaluation-report-search', 'method' => 'GET', 'enctype' => 'multipart/form-data'])); ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\backEnd\teacherEvaluation\report\teacher_approved_evaluation_report.blade.php ENDPATH**/ ?>