<?php $__env->startSection(config('optionbuilder.section')); ?>
    <div class="lb-preloader-outer">
        ...
        <img src="<?php echo e(asset(generalSetting()->preloader_image)); ?>" >
        <div class="lb-loader">
        </div>
    </div>
...
<?php $__env->startPush(config('optionbuilder.style_var')); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('public/vendor/optionbuilder/css/main.css')); ?>">
<?php $__env->stopPush(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make(config('optionbuilder.layout'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\packages\larabuild\optionbuilder\resources\views\index.blade.php ENDPATH**/ ?>