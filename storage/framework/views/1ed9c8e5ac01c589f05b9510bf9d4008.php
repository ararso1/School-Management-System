                            ...
                            <div class="name">
                                <?php if(isset($ContentDetails)): ?>
                                    ...
                                    <?php if($ContentDetails->class != ""): ?>
                                        <p><?php echo app('translator')->get('common.class'); ?>: <?php echo e($ContentDetails->globalClasses->class_name); ?></p>
                                    <?php endif; ?>
                                    <?php if($ContentDetails->section != ""): ?>
                                        <p><?php echo app('translator')->get('common.section'); ?>: <?php echo e($ContentDetails->globalSections->section_name); ?></p>
                                    <?php endif; ?>
                                <?php endif; ?>
                            </div>
                        </div>
                                    ...
                                    <?php if(isset($ContentDetails)): ?>
                                        <?php if(@$ContentDetails->source_url != ""): ?>
                                            ...
                                            <a class="primary-btn small fix-gr-bg" target="_blank" href="<?php echo e(url('videowatch/view/'.$ContentDetails->id)); ?>"><?php echo app('translator')->get('study.click_here'); ?></a>
                                                ...
                                                <a class="primary-btn small fix-gr-bg" target="_blank" href="<?php echo e(url('videowatch/view-log/'.$ContentDetails->id)); ?>"><?php echo app('translator')->get('study.log'); ?></a>
                                                <?php endif; ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        <div class="name">
                            ...
                            <?php else: ?>
                                <a href="<?php echo e(url(@$ContentDetails->upload_file)); ?>" download>
...
<script type="text/javascript">
  ...
  </script><?php /**PATH C:\xampp\htdocs\resources\views\backEnd\global\global_uploadContentDetails.blade.php ENDPATH**/ ?>