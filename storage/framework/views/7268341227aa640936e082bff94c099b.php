...
<section class="sms-breadcrumb mb-20">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('lang.class_time_setup'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(route('dashboard')); ?>"><?php echo app('translator')->get('common.dashboard'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.academics'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.class_time_setup'); ?></a>
            </div>
        </div>
    </div>
</section>
<section class="admin-visitor-area up_st_admin_visitor">
    <div class="container-fluid p-0">
        <?php if(isset($class_time)): ?>
         <?php if(userPermission(274)): ?>
        <div class="row">
            <div class="offset-lg-10 col-lg-2 text-right col-md-12 mb-20">
                <a href="<?php echo e(route('class-time')); ?>" class="primary-btn small fix-gr-bg">
             ...
             <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php if(isset($class_time)): ?>
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => array('class-time-update',$class_time->id), 'method' => 'PUT'])); ?>

                        <?php else: ?>
                         <?php if(userPermission(274)): ?>
           
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'class-time', 'method' => 'POST'])); ?>
                        ...
                        <div class="white-box">
                            <div class="add-visitor">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="primary_input">
                                            ...
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('common.class_period'); ?> <span class="text-danger"> *</span></label>
                                ...
                                <div class="row no-gutters input-right-icon mt-25">
                                    <div class="col">
                                        <div class="primary_input">
                                            <input class="primary_input_field primary_input_field time  form-control<?php echo e(@$errors->has('start_time') ? ' is-invalid' : ''); ?>" type="text" name="start_time" value="<?php echo e(isset($class_time)? $class_time->start_time: ''); ?>">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('lang.select_time'); ?> <span class="text-danger"> *</span></label>
                                ...
                                <div class="row no-gutters input-right-icon mt-25">
                                        <div class="col">
                                            <div class="primary_input">
                                                <input class="primary_input_field primary_input_field time  form-control<?php echo e(@$errors->has('end_time') ? ' is-invalid' : ''); ?>" type="text" name="end_time"  value="<?php echo e(isset($class_time)? $class_time->end_time: ''); ?>">
                                                <label class="primary_input_label" for=""><?php echo app('translator')->get('lang.end_time'); ?> <span class="text-danger"> *</span></label>
            ...
            <div class="col-lg-9">
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-0"><?php echo app('translator')->get('lang.time_list'); ?> </h3>
                        </div>
                    </div>
                </div>
                            ...
                            <thead>
                               <?php if(session()->has('message-success-delete') != "" ||
                                ...
                                <tr>
                                    ...
                                    <th><?php echo app('translator')->get('common.class_period'); ?></th>
...
<?php endif; ?>
                                                <?php if(userPermission(275)): ?>
                                                <a class="dropdown-item" href="<?php echo e(route('class-time-edit',$class_time->id)); ?>"><?php echo app('translator')->get('common.edit'); ?></a>
                                                <?php endif; ?>
                                                 <?php if(userPermission(276)): ?>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title"><?php echo app('translator')->get('common.delete_class_time'); ?></h4>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\backEnd\academics\class_time.blade.php ENDPATH**/ ?>