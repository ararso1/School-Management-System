...
<?php if( !empty($repeater_type) && $repeater_type == 'single' ): ?>
    ...
    <?php else: ?>
        <div class="op-checkbox">
            ...
            <label for="<?php echo e($label_id); ?>"><?php echo e($field_title ?? ''); ?></label>
        </div>
    <?php endif; ?> 
<?php else: ?>
            ...
            <div class="op-textcontent">
                ...
                <?php if( !empty($options) && is_array($options) ): ?>
                    ...
                    <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $single): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <div class="op-checkbox">
                            <input type="checkbox" id="<?php echo e($label_id); ?>" data-multi_items="true" data-id="<?php echo e($id); ?>" <?php if(!empty($parent_rep)): ?>data-parent_rep="<?php echo e($parent_rep); ?>" <?php endif; ?> name="<?php echo e($name); ?>" <?php if( $checked ): ?> checked <?php endif; ?>  value="<?php echo e($key); ?>" class="op-input-field <?php echo e($class ?? ''); ?>" >
                            <label for="<?php echo e($label_id); ?>"><?php echo e($single); ?></label>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\packages\larabuild\optionbuilder\resources\views\components\checkbox.blade.php ENDPATH**/ ?>