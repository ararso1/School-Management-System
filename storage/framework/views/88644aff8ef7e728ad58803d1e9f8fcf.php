                        ...
                        <div class="">
                            ...
                            <div class="row mb-20">
                                ...
                                <?php if(in_array('admission_number', $fields)): ?>
                                    <div class="col-lg-3">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('student.admission_number'); ?> <?php if(is_required('admission_number') == true): ?>
                                                    *
                                                <?php endif; ?>
                                            </label>
                                            <input
                                                class="primary_input_field form-control<?php echo e($errors->has('admission_number') ? ' is-invalid' : ''); ?>"
                                                type="text" name="admission_number" value="<?php echo e($student->admission_no); ?>"
                                ...
                                <?php if(in_array('roll_number', $fields)): ?>
                                    <?php if(generalSetting()->multiple_roll == 0): ?>
                                        <div class="col-lg-3">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for=""><?php echo app('translator')->get('student.roll'); ?>
                                                ...
                                                <input class="primary_input_field read-only-input" type="text"
                                                    ...
                                                    value="<?php echo e($student->roll_no); ?>" readonly id="roll_number">
                            ...
                            <div class="row mb-20">
                                <?php if(in_array('first_name', $fields)): ?>
                                    <div class="col-lg-3">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('student.first_name'); ?>
                                            ...
                                            <input
                                                ...
                                                type="text" name="first_name" value="<?php echo e($student->first_name); ?>">
                                ...
                                <?php if(in_array('last_name', $fields)): ?>
                                    <div class="col-lg-3">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('student.last_name'); ?><?php if(is_required('last_name') == true): ?>
                                                    <span class="text-danger"> *</span>
                                                <?php endif; ?>
                                            </label>
                                            <input
                                                class="primary_input_field form-control<?php echo e($errors->has('last_name') ? ' is-invalid' : ''); ?>"
                                                type="text" name="last_name" value="<?php echo e($student->last_name); ?>">
                                        ...
                                        <div class="primary_input">
                                            ...
                                            <select
                                                ...
                                                <option
                                                    ...
                                                    value=""><?php echo app('translator')->get('common.gender'); ?> <?php if(is_required('gender') == true): ?>
                                                        <span class="text-danger"> *</span>
                                                    <?php endif; ?>
                                                </option>
                                                <?php $__currentLoopData = $genders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gender): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <?php else: ?>
                                                        <option value="<?php echo e($gender->id); ?>"><?php echo e($gender->base_setup_name); ?>
                                ...
                                <?php if(in_array('date_of_birth', $fields)): ?>
                                    <div class="col-lg-3">
                                        <div class="no-gutters input-right-icon">
                                            <div class="col">
                                                <div class="primary_input">
                                                    <label class="primary_input_label" for=""><?php echo app('translator')->get('common.date_of_birth'); ?>
                                                        <?php if(is_required('date_of_birth') == true): ?>
                                                            <span class="text-danger"> *</span>
                                                        <?php endif; ?>
                                                    </label>
                                                    <input
                            ...
                            <div class="row mb-20">
                                        ...
                                        <div class="primary_input">
                                            ...
                                            <select
                                                ...
                                                <option
                                                    ...
                                                    value=""><?php echo app('translator')->get('student.blood_group'); ?> <?php if(is_required('blood_group') == true): ?>
                                                        <span class="text-danger"> *</span>
                                                    <?php endif; ?>
                                                </option>
                                        ...
                                        <div class="primary_input">
                                            ...
                                            <select
                                                ...
                                                <option
                                                    ...
                                                    value=""><?php echo app('translator')->get('student.religion'); ?> <?php if(is_required('religion') == true): ?>
                                                        <span class="text-danger"> *</span>
                                                    <?php endif; ?>
                                                </option>
                                ...
                                <?php if(in_array('caste', $fields)): ?>
                                    <div class="col-lg-2">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('student.caste'); ?>
                                                <?php if(is_required('caste') == true): ?>
                                                    <span class="text-danger"> *</span>
                                                <?php endif; ?>
                                            </label>
                                            <input class="primary_input_field" type="text" name="caste"
                                                value="<?php echo e($student->caste); ?>">
                                ...
                                <?php if(in_array('email_address', $fields)): ?>
                                    <div class="col-lg-3">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('common.email_address'); ?>
                                            ...
                                            <input oninput="emailCheck(this)"
                                                ...
                                                type="text" name="email_address" value="<?php echo e($student->email); ?>">
                                ...
                                <?php if(in_array('phone_number', $fields)): ?>
                                    <div class="col-lg-3">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('common.phone_number'); ?>
                            ...
                            <div class="row mb-20">
                                            ...
                                            <div class="primary_input">
                                                ...
                                                <select
                                                    ...
                                                    <option
                                                        ...
                                                        value=""><?php echo app('translator')->get('student.category'); ?> <?php if(is_required('student_category_id') == true): ?>
                                                            <span class="text-danger"> *</span>
                                                        <?php endif; ?>
                                                    </option>
                                            ...
                                            <div class="primary_input">
                                                ...
                                                <select
                                                    ...
                                                    <option
                                                        ...
                                                        value=""><?php echo app('translator')->get('student.group'); ?> <?php if(is_required('student_group_id') == true): ?>
                                                            <span class="text-danger"> *</span>
                                                        <?php endif; ?>
                                                    </option>
                                                    <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <?php else: ?>
                                                            <option value="<?php echo e($group->id); ?>"><?php echo e($group->group); ?>
                                ...
                                <?php if(in_array('height', $fields)): ?>
                                    <div class="col-lg-2">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('student.height_in'); ?>
                                                <?php if(is_required('height') == true): ?>
                                                    <span class="text-danger"> *</span>
                                                <?php endif; ?> </label>
                                            <input class="primary_input_field" type="text" name="height"
                                ...
                                <?php if(in_array('weight', $fields)): ?>
                                    <div class="col-lg-2">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('student.weight_kg'); ?>
                                                <?php if(is_required('weight') == true): ?>
                                                    <span class="text-danger"> *</span>
                                                <?php endif; ?> </label>
                                            <input class="primary_input_field" type="text" name="weight"
                                        ...
                                        <div class="primary_input">
                                            <select
                                                ...
                                                <option
                                                    ...
                                                    value=""><?php echo app('translator')->get('lead::lead.source'); ?> <?php if(is_required('source_id') == true): ?>
                                                        <span class="text-danger"> *</span>
                                                    <?php endif; ?>
                                                </option>
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="row mt-25">
                                                                <div class="col-lg-12" id="sibling_section_div">
                                                                    <select class="primary_select " name="sibling_section"
                                                                        id="select_sibling_section">
                                                                        <option data-display="<?php echo app('translator')->get('common.section'); ?> *"
                                                                            value=""><?php echo app('translator')->get('common.section'); ?> *</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="row mt-25">
                                                                <div class="col-lg-12" id="sibling_name_div">
                                                                    <select class="primary_select "
                                                                        ...
                                                                        <option data-display="<?php echo app('translator')->get('student.sibling'); ?> *"
                                                                            value=""><?php echo app('translator')->get('student.sibling'); ?> *</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                            ...
                            <input type="hidden" name="sibling_id" value="<?php echo e(count($siblings) > 1 ? 1 : 0); ?>"
                                id="sibling_id">
                                ...
                                <div class="row mt-40 mb-4" id="siblingTitle">
                                    ...
                                    <div class="col-lg-1 text-right col-md-2">
                                        <button type="button" class="primary-btn small fix-gr-bg icon-only ml-10"
                                            data-toggle="modal" data-target="#removeSiblingModal">
                            ...
                            <div class="parent_details" id="parent_details">
                                ...
                                <div class="row mb-20">
                                    <?php if(in_array('fathers_name', $fields)): ?>
                                        <div class="col-lg-3">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for=""><?php echo app('translator')->get('student.father_name'); ?>
                                    ...
                                    <?php if(in_array('fathers_occupation', $fields)): ?>
                                        <div class="col-lg-3">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for=""><?php echo app('translator')->get('student.occupation'); ?>
                                    ...
                                    <?php if(in_array('fathers_phone', $fields)): ?>
                                        <div class="col-lg-3">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for=""><?php echo app('translator')->get('student.father_phone'); ?>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="primary_input">
                                                ...
                                                <div class="primary_file_uploader">
                                                    ...
                                                    <button class="" type="button">
                                                        <label class="primary-btn small fix-gr-bg"
                                                            for="fathers_photo"><?php echo e(__('common.browse')); ?></label>
                                                        <input type="file" class="d-none" name="fathers_photo"
                                                            id="fathers_photo">
                                                    </button>
                                                </div>
                                                <span class="text-danger"><?php echo e($errors->first('fathers_photo')); ?></span>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                </div>
                                ...
                                <div class="row mb-20">
                                    <?php if(in_array('mothers_name', $fields)): ?>
                                        <div class="col-lg-3">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for=""><?php echo app('translator')->get('student.mother_name'); ?>
                                    ...
                                    <?php if(in_array('mothers_phone', $fields)): ?>
                                        <div class="col-lg-3">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for=""><?php echo app('translator')->get('student.mother_phone'); ?>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="primary_input mb-15">
                                                ...
                                                <div class="primary_file_uploader">
                                                    ...
                                                    <button class="" type="button">
                                                        <label class="primary-btn small fix-gr-bg"
                                                            for="mothers_photo"><?php echo e(__('common.browse')); ?></label>
                                                        <input type="file" class="d-none" name="mothers_photo"
                                                            id="mothers_photo">
                                                    </button>
                                                </div>
                                                <span class="text-danger"><?php echo e($errors->first('mothers_photo')); ?></span>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                ...
                                <div class="row mb-20">
                                    <?php if(in_array('guardians_name', $fields)): ?>
                                        <div class="col-lg-3">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for=""><?php echo app('translator')->get('student.guardian_name'); ?>
                                    ...
                                    <?php if(in_array('relation', $fields)): ?>
                                        <div class="col-lg-3">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for=""><?php echo app('translator')->get('student.relation_with_guardian'); ?>
                                    ...
                                    <?php if(in_array('guardians_email', $fields)): ?>
                                        <div class="col-lg-3">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for=""><?php echo app('translator')->get('student.guardian_email'); ?>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="primary_input">
                                                ...
                                                <div class="primary_file_uploader">
                                                    ...
                                                    <button class="" type="button">
                                                        <label class="primary-btn small fix-gr-bg"
                                                            for="guardians_photo"><?php echo e(__('common.browse')); ?></label>
                                                        <input type="file" class="d-none" name="guardians_photo"
                                                            id="guardians_photo">
                                                    </button>
                                                </div>
                                                <span class="text-danger"><?php echo e($errors->first('guardians_photo')); ?></span>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                </div>
                                ...
                                <div class="row mb-20">
                                    <?php if(in_array('guardians_phone', $fields)): ?>
                                        <div class="col-lg-3">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for=""><?php echo app('translator')->get('student.guardian_phone'); ?>
                                    ...
                                    <?php if(in_array('guardian_occupation', $fields)): ?>
                                        <div class="col-lg-3">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for=""><?php echo app('translator')->get('student.guardian_occupation'); ?>
                                ...
                                <?php if(in_array('guardians_address', $fields)): ?>
                                    <div class="row mt-35">
                                        <div class="col-lg-6">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for=""><?php echo app('translator')->get('student.guardian_address'); ?>
                            ...
                            <div class="row mb-30 mt-30">
                                        ...
                                        <div class="primary_input" style="margin-top:53px !important">
                                            <select
                                                ...
                                                <option
                                                    ...
                                                    value=""><?php echo app('translator')->get('lead::lead.city'); ?> <?php if(is_required('lead_city') == true): ?>
                                                        <span class="text-danger"> *</span>
                                                    <?php endif; ?>
                                                </option>
                                ...
                                <?php if(in_array('current_address', $fields)): ?>
                                    <div class="col-lg-4">
                                        <div class="primary_input mt-20">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('student.current_address'); ?>
                                ...
                                <?php if(in_array('permanent_address', $fields)): ?>
                                    <div class="col-lg-4">
                                        <div class="primary_input mt-20">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('student.permanent_address'); ?>
                                        ...
                                        <div class="primary_input">
                                            <select
                                                ...
                                                <option
                                                    ...
                                                    value=""><?php echo app('translator')->get('student.route_list'); ?> <?php if(is_required('route') == true): ?>
                                                        *
                                                    <?php endif; ?>
                                                </option>
                                                <?php $__currentLoopData = $route_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $route_list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <?php else: ?>
                                                        <option value="<?php echo e($route_list->id); ?>"><?php echo e($route_list->title); ?>
                                        ...
                                        <div class="primary_input" id="select_vehicle_div">
                                            <select
                                                ...
                                                <option
                                                    ...
                                                    value=""><?php echo app('translator')->get('student.vehicle_number'); ?> <?php if(is_required('vehicle') == true): ?>
                                                        *
                                                    <?php endif; ?>
                                                </option>
                                                <?php $__currentLoopData = $vehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if(isset($student->vechile_id) && $vehicle->id == $student->vechile_id): ?>
                                                        <option value="<?php echo e($vehicle->id); ?>"
                                                            ...
                                                            <?php echo e($vehicle->vehicle_no); ?></option>
                                                    <?php endif; ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        ...
                                        <div class="primary_input">
                                            <select
                                                ...
                                                <option
                                                    ...
                                                    value=""><?php echo app('translator')->get('dormitory.dormitory_name'); ?> <?php if(is_required('dormitory_name') == true): ?>
                                                        *
                                                    <?php endif; ?>
                                                </option>
                                        ...
                                        <div class="primary_input" id="roomNumberDiv">
                                            <select
                                                ...
                                                <option
                                                    ...
                                                    value=""><?php echo app('translator')->get('academics.room_number'); ?> <?php if(is_required('room_number') == true): ?>
                                                        <span class="text-danger"> *</span>
                                                    <?php endif; ?>
                                                </option>
                                                <?php if($student->room_id != ''): ?>
                                                    <option value="<?php echo e($student->room_id); ?>" selected="true">
                                                        <?php echo e($student->room != '' ? $student->room->name : ''); ?></option>
                                                <?php endif; ?>
                                            </select>
                            ...
                            <div class="row mb-20">
                                <?php if(in_array('national_id_number', $fields)): ?>
                                    <div class="col-lg-3">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('student.national_id_number'); ?>
                                ...
                                <?php if(in_array('local_id_number', $fields)): ?>
                                    <div class="col-lg-3">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('student.birth_certificate_number'); ?>
                                                <?php if(is_required('local_id_number') == true): ?>
                                                    <span class="text-danger"> *</span>
                                                <?php endif; ?> </label>
                                            <input class="primary_input_field form-control" type="text"
                                                name="local_id_number" value="<?php echo e($student->local_id_no); ?>">
                                ...
                                <?php if(in_array('bank_account_number', $fields)): ?>
                                    <div class="col-lg-3">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('student.bank_account_number'); ?>
                                                <?php if(is_required('bank_account_number') == true): ?>
                                                    <span class="text-danger"> *</span>
                                                <?php endif; ?> </label>
                                            <input class="primary_input_field form-control" type="text"
                                                name="bank_account_number" value="<?php echo e($student->bank_account_no); ?>">
                                ...
                                <?php if(in_array('bank_name', $fields)): ?>
                                    <div class="col-lg-3">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('student.bank_name'); ?>
                                                <?php if(is_required('bank_name') == true): ?>
                                                    <span class="text-danger"> *</span>
                                                <?php endif; ?> </label>
                                            <input class="primary_input_field form-control" type="text"
                                                name="bank_name" value="<?php echo e($student->bank_name); ?>">
                                        </div>
                                    </div>
                                <?php endif; ?>
                            </div>
                            <div class="row mb-20 mt-40">
                                <?php if(in_array('bank_name', $fields)): ?>
                                    <div class="col-lg-6">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('student.previous_school_details'); ?>
                                ...
                                <?php if(in_array('additional_notes', $fields)): ?>
                                    <div class="col-lg-3">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('student.additional_notes'); ?>
                                ...
                                <?php if(in_array('ifsc_code', $fields)): ?>
                                    <div class="col-lg-3">
                                        <div class="primary_input mt-50">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('student.ifsc_code'); ?>
                            ...
                            <div class="row mb-20">
                                <?php if(in_array('document_file_1', $fields)): ?>
                                    <div class="col-lg-3">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('student.document_01_title'); ?>
                                                <?php if(is_required('document_title_1') == true): ?>
                                                    <span class="text-danger"> *</span>
                                                <?php endif; ?>
                                            </label>
                                            <input class="primary_input_field" type="text" name="document_title_1"
                                ...
                                <?php if(in_array('document_file_2', $fields)): ?>
                                    <div class="col-lg-3">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('student.document_02_title'); ?>
                                                <?php if(is_required('document_title_2') == true): ?>
                                                    <span class="text-danger"> *</span>
                                                <?php endif; ?>
                                            </label>
                                            <input class="primary_input_field" type="text" name="document_title_2"
                                ...
                                <?php if(in_array('document_file_3', $fields)): ?>
                                    <div class="col-lg-3">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('student.document_03_title'); ?>
                                                <?php if(is_required('document_title_3') == true): ?>
                                                    <span class="text-danger"> *</span>
                                                <?php endif; ?>
                                            </label>
                                            <input class="primary_input_field" type="text" name="document_title_3"
                                ...
                                <?php if(in_array('document_file_4', $fields)): ?>
                                    <div class="col-lg-3">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('student.document_04_title'); ?>
                                                <?php if(is_required('document_title_4') == true): ?>
                                                    <span class="text-danger"> *</span>
                                                <?php endif; ?>
                                            </label>
                                            <input class="primary_input_field" type="text" name="document_title_4"
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\backEnd\studentPanel\my_profile_update.blade.php ENDPATH**/ ?>