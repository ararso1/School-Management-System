...
<?php echo app('translator')->get('front_settings.update_course_details_heading_section'); ?>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('mainContent'); ?>
    <section class="sms-breadcrumb mb-20">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1><?php echo app('translator')->get('front_settings.course_details_heading'); ?></h1>
                <div class="bc-pages">
                    <a href="<?php echo e(route('dashboard')); ?>"><?php echo app('translator')->get('common.dashboard'); ?></a>
                    <a href="#"><?php echo app('translator')->get('front_settings.front_settings'); ?></a>
                    <a href="#"> <?php echo app('translator')->get('front_settings.course_details_heading'); ?></a>
                </div>
            </div>
        </div>
    </section>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="white-box">
                                <div class="main-title">
                                    <h3 class="mb-15">
                                        <?php echo app('translator')->get('front_settings.update_course_details_heading'); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="primary_input">
                                                <label> <?php echo app('translator')->get('front_settings.title'); ?><span class="text-danger"> *</span></label>
                                                <input
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\backEnd\frontSettings\course\courseDetailsHeading.blade.php ENDPATH**/ ?>