...
<body id="abc">
        ...
        <div class="no-print" style="max-width:900px;margin:12px auto;display:flex;gap:8px;flex-wrap:wrap;align-items:center;">
            ...
            ?>
            <?php if($role_id == 2 && $pdfStudentIds && !empty($id_card->id)): ?>
                <a href="<?php echo e(url('generate-id-card-print/'.$pdfStudentIds.'/'.$id_card->id)); ?>?format=pdf"
            ...
            <?php endif; ?>
                ...
                <div class="id_card" id="id_card" style="display: grid !important;grid-template-columns: repeat(<?php echo e(!empty($id_card->design_mode) && $id_card->design_mode === 'template' ? 1 : 3); ?>,1fr) !important;grid-gap: <?php echo e($gridGap); ?>px;justify-content: center;">
                        <?php
                        ...
                        <?php $__currentLoopData = $s_students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staff_student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(($id_card->design_mode ?? 'classic') === 'template' && $role_id == 2): ?>
                                <?php echo $__env->make('backEnd.admin.idCard.partials.template_card', ['id_card' => $id_card, 'student' => $staff_student, 'role_id' => $role_id], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php continue; ?>
                            <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\school-mgt\resources\views/backEnd/admin/idCard/student_id_card_print_bulk.blade.php ENDPATH**/ ?>