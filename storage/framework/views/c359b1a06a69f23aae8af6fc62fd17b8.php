...
<head>
    ...
    <title>Department - School Management System</title>
...
<body class="client dark light">
        ...
        <div class="banner-area">
            <div class="banner-inner">
                <div class="banner-content">
                    ...
                    <a class="primary-btn fix-gr-bg semi-large mt-30" href="#">Learn More About Us</a>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-9">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="news-item">
                                <div class="news-img">
                                    <img class="img-fluid w-100" src="<?php echo e(asset('public/backEnd/img/client/news/news1.jpg')); ?>" alt="">
                                </div>
                                <div class="news-text">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="news-item">
                                <div class="news-img">
                                    <img class="img-fluid w-100" src="<?php echo e(asset('public/backEnd/img/client/news/news2.jpg')); ?>" alt="">
                                </div>
                                <div class="news-text">
                                    <p class="date">17th Nov, 2018</p>
                                    <h4>
    ...
    <!--================ Department Area =================-->
    <section class="department-area section-gap-bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h3 class="mt-30">What are we looking for?</h3>
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="events-item">
                                <div class="card">
                                    <img class="card-img-top" class="img-fluid" src="<?php echo e(asset('public/backEnd/img/client/events/event1.jpg')); ?>" alt="">
                                    <div class="card-body">
                                        <h5 class="card-title">
                                            Structural study of
                                            antibiotic opens the way
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="events-item">
                                <div class="card">
                                    <img class="card-img-top" class="img-fluid" src="<?php echo e(asset('public/backEnd/img/client/events/event2.jpg')); ?>" alt="">
                                    <div class="card-body">
                                        <h5 class="card-title">
                                            Structural study of
                                            antibiotic opens the way
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="events-item">
                                <div class="card">
                                    <img class="card-img-top" class="img-fluid" src="<?php echo e(asset('public/backEnd/img/client/events/event3.jpg')); ?>" alt="">
                                    <div class="card-body">
                                        <h5 class="card-title">
                                            Structural study of
                                            antibiotic opens the way
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="events-item">
                                <div class="card">
                                    <img class="card-img-top" class="img-fluid" src="<?php echo e(asset('public/backEnd/img/client/events/event4.jpg')); ?>" alt="">
                                    <div class="card-body">
                                        <h5 class="card-title">
                                            Structural study of
                                            antibiotic opens the way
...
<script src="<?php echo e(asset('public/backEnd/')); ?>/vendors/js/toastr.min.js"></script>
...
<?php /**PATH C:\xampp\htdocs\resources\views\frontEnd\home\light_department.blade.php ENDPATH**/ ?>