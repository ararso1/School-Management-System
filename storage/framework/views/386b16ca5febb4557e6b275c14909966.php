...
<section class="sms-breadcrumb mb-20">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('inventory.sells_details'); ?></h1>
            <div class="bc-pages">
                ...
                <a href="#"> <?php echo app('translator')->get('inventory.sells_details'); ?></a>
            </div>
        </div>
    </div>
</section>
                                ...
                                <div class="invoice-details-left">
                                    <div class="mb-20">
                                        ...
                                        <label for="companyLogo" class="company-logo">
                                            <i class="ti-image"></i> 
                                            <img src="<?php echo e(asset('public/uploads/settings/logo.png')); ?>" alt="">
                                        </label>
                            ...
                            <div class="offset-lg-4 col-lg-4">
                                <div class="invoice-details-right">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <p class="fw-500 primary-color"><?php echo app('translator')->get('inventory.sell_date'); ?>:</p>

                                       
                                        <p><?php echo e((isset($viewData)) ?  dateConvert($viewData->sell_date) : ''); ?></p>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <p>
                                            ...
                                            <?php else: ?>
                                            <strong><?php echo app('translator')->get('inventory.unpaid'); ?></strong>
                                            <?php endif; ?>
                                        </p>
                                    </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\backEnd\inventory\viewItemSell.blade.php ENDPATH**/ ?>