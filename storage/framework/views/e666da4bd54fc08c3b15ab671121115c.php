        ...
        <div class="row mt-40">
            ...
            <?php if(@$graduate): ?>
                <div class="col-lg-8 pull-right">
                    <a href="<?php echo e(route('alumni.print-transcript', [$graduate->id])); ?>"class="primary-btn small fix-gr-bg pull-right mb-20" target="_blank">
                    ...
                    <table>
                        <tbody>
                            <tr>
                                <td></td>
                                <td></td>
                                <td><?php echo app('translator')->get('common.date'); ?>- <?php echo e(date("Y/m/d")); ?></td>
                                <td></td>
                            </tr>
                        </tbody>
                    </table>
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\backEnd\graduate\transcript\studentTranscript.blade.php ENDPATH**/ ?>