...
<?php echo app('translator')->get('exam.subject_wise_mark_sheet'); ?>
    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="#"><?php echo app('translator')->get('exam.subject_wise_mark_sheet'); ?></a>
            </div>
        </div>
    </section>
                          ...
                          <div class="col-lg-4 mt-30-md" id="select_class_subject_div">
                              <select class="primary_select form-control<?php echo e($errors->has('subject') ? ' is-invalid' : ''); ?> select_subject" id="select_class_subject" name="subject">
                                  ...
                                  <?php if(isset($subject)): ?>
                                    <option value="<?php echo e($subject->id); ?>" selected><?php echo e($subject->subject_name); ?></option>
                                  <?php endif; ?> 
                              </select>
...
<?php if(isset($sm_mark_stores)): ?>
    <?php if(moduleStatusCheck('University')): ?>
        <?php if ($__env->exists('university::exam.un_subject_mark_sheet')) echo $__env->make('university::exam.un_subject_mark_sheet', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php else: ?>
                ...
                <div class="row">
                    <div class="col-lg-12 no-gutters">
                        <div class="main-title d-flex ">
                            <h3 class="mb-30 flex-fill"><?php echo app('translator')->get('exam.subject_wise_mark_sheet'); ?></h3>
                            <div class="print_button pull-right">
                                <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' =>'subjectMarkSheetPrint', 'method' => 'POST', 'enctype' => 'multipart/form-data','target' => '_blank'])); ?>


                                <input type="hidden" name="class" value="<?php echo e($class->id); ?>">
                                <input type="hidden" name="subject" value="<?php echo e($subject->id); ?>">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 text-black"> 
                                                        ...
                                                        <div class="row mt-20">
                                                            ...
                                                            <div class="col-lg-6">
                                                                  <p class="mb-0">
                                                                        <?php echo app('translator')->get('exam.subject'); ?> : <span class="primary-color fw-500"><?php echo e(@$subject->subject_name); ?> [<?php echo e(@$subject->subject_code); ?>]</span>
                                                                    </p>
                                                                    <p class="mb-0">
                                                                        <?php echo app('translator')->get('exam.pass_mark'); ?> : <span class="primary-color fw-500"><?php echo e(@$subject->pass_mark); ?></span>
                                                                    </p>
                                                            ...
                                                            <tr>
                                                                  ...
                                                                  <?php if(count($result_setting) > 0): ?> 
                                                                    ...
                                                                    <th>
                                                                            ...
                                                                            <br>
                                                                            <?php echo e(@$exam->exam_percentage); ?> %
                                                                  ...
                                                                  <?php $__currentLoopData = examTypes(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <th>
                                                                            ...
                                                                            <br>
                                                                            <?php echo e(subjectFullMark($exam->id, $subject->id)); ?> 
                                                        ...
                                                        <?php $__currentLoopData = $finalMarkSheets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $finalMarkSheet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                ...
                                                                <?php
                                                                    ...
                                                                    $total = 0;
                                                                ?>
                                                                <?php $__currentLoopData = $finalMarkSheet->get('examTypeMarks'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $examMark): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <?php
                                                                        $total += $examMark->get('single_avg_mark');
                                                                        $exam_count += 1;
                                                                    ?>
                                                                    <td><?php echo e($examMark->get('single_avg_mark')); ?></td>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                ...
                                                                <td><?php echo e(getGrade($avg,true)); ?></td>
                                                            </tr>
                                                         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                      </tbody>
                                                    </table>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\backEnd\examination\subjectMarkSheetList.blade.php ENDPATH**/ ?>