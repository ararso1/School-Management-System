                    ...
                    <div class="permission_header d-flex align-items-center justify-content-between">
                        <div>
                            <input type="hidden" name="all_modules_id[]" value="<?php echo e($module_info->infix_module_id); ?>">
                                ...
                                <label for="Main_Module_<?php echo e($key); ?>"><?php echo e(__('menumanage::menuManage.'.$module_info->name)); ?></label>
                        </div>
                                            ...
                                            <?php $__currentLoopData = $childModule; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row3): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <li >
                                                    <div class="module_link_option_div" id="<?php echo e($row2->infix_module_id); ?>">
                                                        ...
                                                        <label class="nowrap" for="Option_<?php echo e($row3->id); ?>"><?php echo e(__('menumanage::menuManage.'.$row3->name)); ?></label>
                                                        <br>
                                                    </div>
                                                </li>
            ...
            <div class="permission_header d-flex align-items-center justify-content-between">
                <div>
                       <input type="hidden" name="all_modules_id[]" value="<?php echo e($module_info->id); ?>">
                        ...
                        <label for="Main_Module_<?php echo e(10000-$key); ?>"><?php echo e(__('menumanage::menuManage.'.$module_info->name)); ?></label>
                </div>
                <div class="arrow collapsed" data-toggle="collapse" data-target="#Role<?php echo e($module_info->id); ?>"></div>
            </div>
            <div id="Role<?php echo e($module_info->id); ?>" class="collapse">
         ...
         <div class="row mt-40">
            <div class="col-lg-12 text-center">
                ...
                <?php if(Illuminate\Support\Facades\Config::get('app.app_sync')): ?>
                    <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Disabled For Demo "> <button class="primary-btn fix-gr-bg  demo_view" style="pointer-events: none;" type="button" ><?php echo app('translator')->get('menumanage::menuManage.submit'); ?> </button></span>
                <?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Modules\MenuManage\Resources\views\index_copy.blade.php ENDPATH**/ ?>