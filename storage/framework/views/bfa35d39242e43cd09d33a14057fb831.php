    ...
    <section class="sms-breadcrumb mb-20">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1><?php echo app('translator')->get('fees::feesModule.payment_report'); ?></h1>
                <div class="bc-pages">
                    ...
                    <a href="#"><?php echo app('translator')->get('fees::feesModule.payment_report'); ?></a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        ...
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'route' => 'fees.payment-search', 'method' => 'POST'])); ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Modules\Fees\Resources\views\report\payment.blade.php ENDPATH**/ ?>