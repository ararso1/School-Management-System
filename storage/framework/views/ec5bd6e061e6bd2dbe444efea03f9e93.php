                        ...
                        <div class="row">
                                ...
                                <div class="row no-gutters input-right-icon">
                                    <div class="col">
                                        <div class="primary_input">
                                            <input class="primary_input_field" type="text" id="placeholderInput" placeholder="Upload File"
                                                disabled>
                            ...
                            <div class="col-lg-6 mt-30-md">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="primary_input">
                                            <input class="primary_input_field form-control" id="uploadYoutubeVideo" type="text">
                                            <label for="uploadYoutubeVideo">Upload Youtube Video <span class="text-danger"> *</span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mt-30-md">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="primary_input">
                                            <input class="primary_input_field form-control" type="text" id="searchByFileName">
            ...
            <div class="col-lg-2 mb-30">
                <div class="single-cms-box text-center">
                    <div class="single-cms">
                        ...
                        <img class="img-fluid cms-img" src="<?php echo e(asset('public/backEnd/img/front-cms/cms1.jpg')); ?>" alt="">
                        <div class="icons">
                            <a class="pop-up-image" href="<?php echo e(asset('public/backEnd/img/front-cms/cms1.jpg')); ?>">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\frontEnd\front_cms_media_manager.blade.php ENDPATH**/ ?>