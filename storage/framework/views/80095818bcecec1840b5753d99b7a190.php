...
<head>
    ...
    <title>Infix Edu ERP | Verify Your purchase <?php echo e(@$name); ?> Module</title>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="justify-content-center">
                    <p class=" text-red purchase-alert">If you are using <?php echo e(@$name); ?> Module without purchase, Please contact with us at <a target="_blank" href="mailto:support@spondonit.com">support@spondonit.com</a>.</p>
                    <p class="purchase-alert"> If you already purchase <?php echo e(@$name); ?> Module, please verification again. Thanks !</p>
                    ...
                    <form method="POST" action="<?php echo e(url('module-verify-purchase')); ?>" class="mt-40">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control " name="name"  required="required"  placeholder="Enter Your Envato User Name" value="<?php echo e(@$name); ?>}}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="installationdomain" required="required"  placeholder="Enter Your Installation Domain" value="<?php echo e(url('/')); ?>">
                        </div>
...
<?php /**PATH C:\xampp\htdocs\resources\views\install\Moduleverify.blade.php ENDPATH**/ ?>