...
<head>
    ...
    <title><?php echo e(@$certificate->name); ?> (<?php echo e(@$certificate->width . 'mm'); ?> X <?php echo e(@$certificate->height . 'mm'); ?>)
    </title>
    <link rel="stylesheet" href="<?php echo e(asset('Modules/Certificate/Resources/assets/css/editor.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('Modules/Certificate/Resources/assets/css/paper/normalize.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('Modules/Certificate/Resources/assets/css/paper/paper.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('public/backEnd/vendors/css/bootstrap.min.css')); ?>" />
    <style>
        @font-face {
            font-family: 'Pinyon Script';
            src: url('<?php echo e(asset('public/backEnd/fonts/pinyonscript-regular-webfont.woff')); ?>') format('woff2'),
                url('<?php echo e(asset('public/backEnd/fonts/pinyonscript-regular-webfont.woff')); ?>') format('woff');
            font-weight: normal;
            font-style: normal;
        ...
        .edu_summernote {
            font-family: '<?php echo e($certificate->body_font_family); ?>', sans-serif;
    ...
    <style>
        ...
        .first_element{
            margin-left: 0%;
            margin-top: <?php echo e($first_element_margin_top); ?>;
        }
        .second_element{
            display: flex;
            margin-top: <?php echo e($second_element_margin_top); ?>;
        }
        ...
        .certificate_body_table {
            margin-top: <?php echo e($half_of_certificate_height - 10); ?>mm;
        }

        .setup_height_width {
            /* width: <?php echo $style_width ?>
            ;
            */ height: <?php echo e($style_height); ?>;
            width: <?php echo e($style_width); ?>;
        }
        ...
        .edu_summernote {
            font-size: <?php echo e($body_font_size); ?>;
        }
        ...
        .img-100 {
            max-width: <?php echo e($student_image_size); ?>;
            height: auto;
            border-radius: 6px;
        }
...
<body class="A4">
    <div class="certificate setup_height_width">
        <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="DivBody setup_height_width">
                <img class="position_bg setup_height_width" src="<?php echo e(asset($certificate->file)); ?>">
                        ...
                        <div style="display: flex; justify-content: center;">
                            ...
                            <div style="flex: 8;">
                                <div class="first_element">
                                    <div style="flex: 6;">
                                        <?php if($certificate->student_photo == 1): ?>
                                        <img class="student-meta-img img-100"
                                            src="<?php echo e(file_exists(@$student->student->student_photo) ? asset($student->student->student_photo) : asset('public/uploads/staff/demo/staff.jpg')); ?>"
                                            alt="">
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="second_element" style="">
                                    <div style="flex: 6;"><?php echo e(@$certificate->header_left_text); ?></div>
                                    <div style="flex: 6; text-align: right; white-space: nowrap;"><?php echo app('translator')->get('common.date'); ?>:
                                        <?php echo e(@$certificate->date); ?></div>
                                </div>
                                <div class="edu_summernote" style="text-align: center; margin-top: 7%;">
                                    <?php echo e(isset($student['student_id']) ? App\SmStudentCertificate::certificateBody($certificate->body, 2, $student['student_id']) : ''); ?>
                                ...
                                <div style="text-align: center; margin-top: 20%; display:flex;">
                                    <div
                                        ...
                                        <?php echo e(@$certificate->footer_left_text); ?>

                                    </div>
                                    <div
                                        style="flex: 4; border-top: 1px solid #000; margin-top: 20px; margin-right: 5px;">
                                        <?php echo e(@$certificate->footer_center_text); ?>

                                    </div>
                                    <div style="flex: 4; border-top: 1px solid #000; margin-top: 20px;">
                                        <?php echo e(@$certificate->footer_right_text); ?>
            ...
            <?php if($is_possible_to_print_2_certificate_in_a_page): ?>
                <?php if($key % 2 != 0): ?>
                    <div class="page_break"></div>
                <?php endif; ?>
            <?php elseif($certificate->layout == 1): ?>
                <div class="page_break"></div>
            <?php endif; ?>
    ...
    <script src="<?php echo e(asset('https://infix_edu.test/public/backEnd/vendors/js/jquery-3.2.1.min.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\resources\views/backEnd/admin/student_certificate_print.blade.php ENDPATH**/ ?>