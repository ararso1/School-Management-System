...
<section class="admin-visitor-area up_st_admin_visitor">
    <div class="container-fluid p-0">
        <?php if(isset($route)): ?>
            <?php if(userPermission("transport-route-store")): ?>
                <div class="row">
                    <div class="offset-lg-10 col-lg-2 text-right col-md-12 mb-20">
                        <a href="<?php echo e(route('transport-route-index')); ?>" class="primary-btn small fix-gr-bg">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php else: ?>
                                ...
                                <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'transport-route-store', 'method' => 'POST', 'enctype' => 'multipart/form-data'])); ?>
                        ...
                        <div class="white-box">
                            ...
                            <div class="add-visitor">
                                <div class="row">
                                    <div class="col-lg-12"> 
                                        <div class="primary_input">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('transport.route_title'); ?> <span class="text-danger"> *</span></label>
                                            <input class="primary_input_field " type="text" name="title" autocomplete="off" value="<?php echo e(isset($route)? @$route->title:old('title')); ?>">
                                ...
                                <div class="row mt-15">
                                    <div class="col-lg-12">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('transport.fare'); ?> <span class="text-danger"> *</span></label>
                                            <input class="primary_input_field form-control<?php echo e($errors->has('far') ? ' is-invalid' : ''); ?>" type="number" step="0.1" name="far" autocomplete="off" value="<?php echo e(isset($route)? @$route->far:old('far')); ?>">
                                          
                                            
                                            <?php if($errors->has('far')): ?>
                                                <span class="text-danger" >
                                                    <?php echo e($errors->first('far')); ?>
                ...
                <div class="white-box">
                    <div class="row">
                        <div class="col-lg-4 no-gutters">
                            <div class="main-title">
                                <h3 class="mb-15">  <?php echo app('translator')->get('transport.route_list'); ?></h3>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views/backEnd/transport/route.blade.php ENDPATH**/ ?>