...
<head>
    ...
    <title><?php echo app('translator')->get('exam.subject_mark_sheet'); ?></title>
    <style>
                                   ...
                                   <tr>
                                       <td>
                                        ...
                                        <td>
                                            <p class="line_grid" >
                                                <span>
                                                    <span><?php echo app('translator')->get('common.subject'); ?></span>
                                                    <span>:</span>
                                                </span>
                                   ...
                                   <tr>
                                        ...
                                        <td>
                                            <p class="line_grid" >
                                                ...
                                                <?php echo e(@generalSetting()->academic_year->year); ?> [<?php echo e(@generalSetting()->academic_year->title); ?>]
                                            </p>
                                        </td>
                                        <td>
                ...
                <tbody>
                  ...
                  <?php $__currentLoopData = $finalMarkSheets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $finalMarkSheet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr>
                            ...
                            <td> <?php echo e(($finalMarkSheet->get('avg_mark'))); ?></td>
                            <td>
                                <?php if($subject->pass_mark <= $finalMarkSheet->get('avg_mark')): ?>
...
<?php /**PATH C:\xampp\htdocs\resources\views\backEnd\examination\subjectMarkSheetPrint.blade.php ENDPATH**/ ?>