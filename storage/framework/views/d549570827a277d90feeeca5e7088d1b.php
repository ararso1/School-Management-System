<?php if(generalSetting()->preloader_status): ?>
    <?php if(generalSetting()->preloader_type==2): ?>
        <div class="preloader" dir="ltr">
            <img style="width: 200px" src="<?php echo e(asset(generalSetting()->preloader_image)); ?>" alt="preloader">
        </div>
    <?php else: ?>
        <?php if(!generalSetting()->preloader_style||generalSetting()->preloader_style==1): ?>
            <div class="preloader" dir="ltr">
                <div class="circle circle1"></div>
            </div>
        <?php elseif(generalSetting()->preloader_style==2): ?>


            <div class="preloader" dir="ltr">
                <div class="circle circle2"></div>
            </div>
        <?php elseif(generalSetting()->preloader_style==3): ?>
            <div class="preloader" dir="ltr">
                <div class="circle circle3 c31"></div>
                <div class="circle circle3 c32"></div>
            </div>
        <?php elseif(generalSetting()->preloader_style==4): ?>
            <div class="preloader" dir="ltr">
        ...
        <?php elseif(generalSetting()->preloader_style==5): ?>
            <div class="preloader" dir="ltr">
                <div class="circle circle5 c51"></div>
            </div>
        <?php elseif(generalSetting()->preloader_style==6): ?>
            <div class="preloader" dir="ltr">
        ...
        <?php elseif(generalSetting()->preloader_style==7): ?>
            <div class="preloader" dir="ltr">
        ...
        <?php elseif(generalSetting()->preloader_style==8): ?>
            <div class="preloader" dir="ltr">
        ...
        <?php elseif(generalSetting()->preloader_style==9): ?>
            <div class="preloader" dir="ltr">
        ...
        <?php elseif(generalSetting()->preloader_style==10): ?>
            <div class="preloader" dir="ltr">
        ...
        <?php elseif(generalSetting()->preloader_style==11): ?>
        ...
        <?php elseif(generalSetting()->preloader_style==12): ?>
        ...
        <?php elseif(generalSetting()->preloader_style==13): ?>

            <div class="preloader" dir="ltr">
                <div class="circle circle13 c131"></div>
            </div>
        <?php elseif(generalSetting()->preloader_style==14): ?>

            <div class="preloader" dir="ltr">
                <div class="circle circle14 c141"></div>
            </div>
        <?php elseif(generalSetting()->preloader_style==15): ?>

            <div class="preloader" dir="ltr">
                <div class="circle circle15 c151"></div>
            </div>
        <?php elseif(generalSetting()->preloader_style==16): ?>
        ...
        <?php elseif(generalSetting()->preloader_style==17): ?>
        ...
        <?php elseif(generalSetting()->preloader_style==18): ?>

            <div class="preloader" dir="ltr">
                <div class="dot dot3"></div>
                <div class="dot dot3 dot31"></div>
            </div>
        <?php elseif(generalSetting()->preloader_style==19): ?>

            <div class="preloader" dir="ltr">
                <div class="dot dot4"></div>
                <div class="dot dot4 dot41"></div>
            </div>
        <?php elseif(generalSetting()->preloader_style==20): ?>
        ...
        <?php elseif(generalSetting()->preloader_style==21): ?>
        ...
        <?php elseif(generalSetting()->preloader_style==22): ?>
        ...
        <?php elseif(generalSetting()->preloader_style==23): ?>
        ...
        <?php elseif(generalSetting()->preloader_style==24): ?>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\school-mgt\resources\views/backEnd/preloader.blade.php ENDPATH**/ ?>