...
<html lang="en">
<head>
  <title><?php echo app('translator')->get('exam.progress_card'); ?></title>
  <meta charset="utf-8">
...
<div class="container"> 
        ...
        <h4 style=" text-align: center;  padding: 10px;"><?php echo app('translator')->get('exam.student_progress_card'); ?></h4> 
        ...
        <div class="student_marks_table" style="margin-top:20px">
            <table class="custom_table">
              <thead>
                <tr>
                  <th colspan="<?php echo e($assign_subjects->count()+11); ?>" class="full_width" ><?php echo e($item->title); ?> <?php echo e($percentage); ?>% </th>
                </tr>
                <tr>
                    <?php $__currentLoopData = $assign_subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <td colspan="2"><?php echo e($subject->subject_name); ?> </td>
                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <td rowspan="<?php echo e($assign_subjects->count()+11); ?>" > <?php echo app('translator')->get('exam.gpa'); ?> </td>
                </tr>
              </thead>
              <tbody>
                <tr>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  <td rowspan="<?php echo e($assign_subjects->count()+11); ?>" >
                    <?php
...
<div class="student_marks_table" style="margin-top:20px;">
    ...
    <thead>
        ...
        <th>
            Final GPA : <?php echo e($student_final_result); ?>

        </th>
        <th>
            Final Grade : <?php echo e(App\CustomResultSetting::gpaToGrade($student_final_result)); ?>
...
<?php /**PATH C:\xampp\htdocs\resources\views\backEnd\reports\custom_progress_card_print.blade.php ENDPATH**/ ?>