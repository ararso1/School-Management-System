...
<?php if(isset($per["Image Banner"]) and $homePage): ?>
    <?php
                    ...
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-5 text-md-right text-left mb-30-lg">
                                <a href="<?php echo e(url('news-page')); ?>"
                                   class="primary-btn small fix-gr-bg"><?php echo app('translator')->get('front_settings.browse_all'); ?></a>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="academic-item">
                                        ...
                                        <div class="academic-text">
                                            ...
                                            <p>
                                                <?php echo substr(strip_tags($academic->overview), 0, 50); ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row mb-40">
                            ...
                            <div class="col-lg-6 col-md-5 text-md-right text-left mb-30-lg">
                                <a href="#" class="primary-btn small fix-gr-bg"><?php echo app('translator')->get('front_settings.browse_all'); ?></a>
                            </div>
                        </div>
                        <div class="row">
...
<?php echo $__env->make('frontEnd.home.front_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\frontEnd\home\light_home.blade.php ENDPATH**/ ?>