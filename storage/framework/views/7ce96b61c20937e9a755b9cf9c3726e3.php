                    ...
                    <div class="white-box">
                        <ul class="nav nav-tabs tabs_scroll_nav mb-10" role="tablist">
                            ...
                            <li class="nav-item edit-button">
                                ...
                                ?>
                                <?php if($studentIdCards->isNotEmpty()): ?>
                                    <a href="<?php echo e(route('student_id_card_view', [@$student_detail->id])); ?>"
                                        class="primary-btn small fix-gr-bg" target="_blank">ID Card</a>
                                    <a href="<?php echo e(route('student_id_card_print', [@$student_detail->id])); ?>"
                                        class="primary-btn small fix-gr-bg" target="_blank">Print ID</a>
                                    <a href="<?php echo e(route('student_id_card_download', [@$student_detail->id])); ?>"
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\school-mgt\resources\views/backEnd/studentInformation/student_view.blade.php ENDPATH**/ ?>