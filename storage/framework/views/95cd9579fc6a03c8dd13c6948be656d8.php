...
<head>
    ...
    <title><?php echo e(isset($setting)? !empty($setting->site_title) ? $setting->site_title : 'System ': 'System '); ?> | <?php echo app('translator')->get('auth.login'); ?></title>
    <style>
                    ...
                    <div class="in_login_content">
                        ...
                        <div class="in_login_page_iner">
                            <div class="in_login_page_header">
                                <h5><?php echo e(__('Registration')); ?> <?php echo app('translator')->get('common.details'); ?></h5>
                            </div>
                            ...
                            <div class="col-12">
                                    ...
                                    <?php if($errors->has('school_id')): ?>
                                        <span class="invalid-select text-left text-danger pl-3" role="alert">
                                            <?php echo e($errors->first('school_id')); ?>
                                ...
                                <div class="in_single_input">
                                    <input type="text" placeholder="<?php echo app('translator')->get('auth.enter_name'); ?>" name="fullname" class="<?php echo e($errors->has('fullname') ? ' is-invalid' : ''); ?>" value="<?php echo e(old('fullname')); ?>" id="fullname">
                                ...
                                <div class="in_single_input">
                                    <input type="text" placeholder="<?php echo app('translator')->get('auth.enter_email'); ?>" name="email" class="<?php echo e($errors->has('email') ? ' is-invalid' : ''); ?>" value="<?php echo e(old('email')); ?>" id="email-address">
                                    <span class="addon_icon">
                                        <i class="ti-email"></i>
                                    </span>
                                ...
                                <div class="in_single_input">
                                    <input type="password" placeholder="<?php echo app('translator')->get('auth.enter_password'); ?>" name="password" class="<?php echo e($errors->has('password') ? ' is-invalid' : ''); ?>" value="<?php echo e(old('password')); ?>">
                                    <span class="addon_icon">
                                        <i class="ti-key"></i>
                                    </span>
                                ...
                                <div class="in_single_input">
                                    <input type="password" placeholder="<?php echo app('translator')->get('auth.enter_confirm_password'); ?>" name="password_confirmation"
...
<?php /**PATH C:\xampp\htdocs\resources\views\auth\registerCodeCanyon.blade.php ENDPATH**/ ?>