...
<head>
    ...
    <title><?php echo app('translator')->get('student.export_to_pdf'); ?></title>
    <style>
        body{
            ...
            <div class="container">
                <div class="invoice_part_iner">
                            ...
                            <td>
                                <div class="logo_img">
                                    <div class="thumb_logo">
                                        <img src="<?php echo e(asset('/')); ?><?php echo e(generalSetting()->logo); ?>" alt="<?php echo e($school_name); ?>">
                                    </div>
                    ...
                    <div class="table_title">
                        <h3><?php echo app('translator')->get('student.all_student'); ?></h3>
                    </div>
                    <!-- middle content  -->
                    <table class="table">
                        <tbody>
                                           ...
                                           <tr>
                                               <td>
                                                <p class="line_grid" >
                                                    ...
                                                    <?php echo e($academiYear->year); ?> (<?php echo e($academiYear->title); ?>)
                                                </p>
                                            </td>
                                            <td>
                                                <p class="line_grid" >
            ...
            <tbody>
                <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            <?php $__currentLoopData = @$student->studentRecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classSection): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php echo e($classSection->class->class_name); ?> (<?php echo e($classSection->section->section_name); ?>) <?php if(count($student->studentRecords) > 1): ?>, <?php endif; ?>  
...
<?php /**PATH C:\xampp\htdocs\resources\views\backEnd\studentInformation\allStudentExportPdfPrint.blade.php ENDPATH**/ ?>