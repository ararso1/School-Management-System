...
<?php echo app('translator')->get('exam.take_online_exam'); ?>
    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="<?php echo e(route('take_online_exam',@$online_exam->id)); ?>"><?php echo app('translator')->get('exam.take_online_exam'); ?></a>
            </div>
        </div>
    </div>
</section>
                                ...
                                <tbody>
                                    <tr align="center" class="exam-bg">
                                        <td colspan="2" class="pt-4 pb-3 px-sm-5">
                                            <h1><?php echo app('translator')->get('exam.exam_name'); ?> : <?php echo e(@$online_exam->title); ?></h1>
                                            <h2><strong><?php echo app('translator')->get('common.subject'); ?> : </strong><?php echo e(@$online_exam->subject !=""?@$online_exam->subject->subject_name:""); ?></h2>
                                            <h6><strong><?php echo app('translator')->get('common.class_Sec'); ?> : </strong><?php echo e(@$online_exam->class !=""?@$online_exam->class->class_name:""); ?> (<?php echo e(@$online_exam->section !=""?@$online_exam->section->section_name:""); ?>)</h6>
                                            <h3 class="mb-20"><strong><?php echo app('translator')->get('exam.total_marks'); ?> : </strong>
                                            <?php
                                            @$total_marks = 0;
                                                ...
                                                <div class="row">
                                                    <div class="col-10">
                                                        <div class="primary_input mt-20">
                                                            ...
                                                            <textarea class="primary_input_field form-control mt-10 form_filler_<?php echo e(@$question->question_bank_id); ?>" name="answer_word_<?php echo e(@$question->question_bank_id); ?>" id="answer_word_<?php echo e(@$question->question_bank_id); ?>"><?php echo e(isset($submited_answer)? $submited_answer->user_answer : ''); ?> </textarea>
                                                           
                                                            
                                                        </div>
                                                    </div>
                                                    <div class="col-2">
                                                        <p class="primary-btn fix-gr-bg" data-question = "<?php echo e(@$question->question_bank_id); ?>" onclick="fillBlanks(<?php echo e(@$question->question_bank_id); ?>)"><?php echo e(__('common.Fill')); ?></p>
                                                    </div>
                                                </div>
                                    ...
                                    <tr>
                                        <td colspan="2" class="text-center pt-4">
                                            <button class="primary-btn fix-gr-bg">
                                                ...
                                                <?php echo app('translator')->get('exam.submit_exam'); ?>
                                            </button>
                                        </td>
                                    </tr>
                                </tbody>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\backEnd\studentPanel\take_online_exam.blade.php ENDPATH**/ ?>