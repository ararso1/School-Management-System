        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <h2>Introduction</h2>
                    <p>
                        Welcome to the The <strong><?php echo e(@$setting->school_name); ?></strong> website located at <strong><?php echo e(url('/')); ?></strong> (the “Website”).
...
<?php echo $__env->make('frontEnd.home.front_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\frontEnd\home\institutionTermServices.blade.php ENDPATH**/ ?>