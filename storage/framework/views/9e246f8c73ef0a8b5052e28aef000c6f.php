                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <select class="primary_select ">
                                                            <option data-display="Purpose *">Purpose <span class="text-danger"> *</span> </option>
                                                ...
                                                <div class="row mt-25">
                                                    <div class="col-lg-12">
                                                        <div class="primary_input">
                                                            <textarea class="primary_input_field form-control" cols="0" rows="3"></textarea>
                                                ...
                                                <div class="row mt-25">
                                                    <div class="col-lg-12">
                                                        <div class="primary_input">
                                                            ...
                                                            <textarea class="primary_input_field form-control" cols="50" rows="3"></textarea>
                                                            <label>Description</label>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\frontEnd\admin_setup.blade.php ENDPATH**/ ?>