...
<head>
    ...
    <title><?php echo app('translator')->get('exam.final_mark_sheet'); ?> <?php echo e(@$student_detail->admission_no); ?></title>
    <style>
                            ...
                            <td style="padding: 0">
                                <div class="logo_img">
                                    ...
                                    <div class="profile_thumb">
                                        <img src="<?php echo e(file_exists(@$student_detail->student_photo) ? asset($student_detail->student_photo) : asset('public/uploads/staff/demo/staff.jpg')); ?>" alt="<?php echo e(@$student_detail->full_name); ?>" height="100" width="100">
                                    </div>
                                </div>
                            </td>
                        </thead>
                                 ...
                                 <tbody>
                                     ...
                                     <tr>
                                         <td>
                                              <p class="line_grid">
                                                <span>
                                                      <span><?php echo app('translator')->get('common.student_name'); ?></span>
                                                      <span>:</span>
                                                  </span>
                                     ...
                                     <tr>
                                         <td>
                                              <p class="line_grid" >
                                                  ...
                                                  <?php echo e(@$studentDetails->academic->year); ?>
                                          ...
                                          <td>
                                              <p class="line_grid" >
                                                  ...
                                                  <?php echo e(@$studentDetails->class->class_name); ?>
                                     ...
                                     <tr>
                                          ...
                                          <td>
                                              <p class="line_grid" >
                                                  ...
                                                  <?php echo e($studentDetails->section->section_name); ?>

                                              </p>
                                              <p class="line_grid" >
                                                <span>
                                                    <span><?php echo app('translator')->get('exam.pass_mark'); ?></span>
                                                    <span>:</span>
                                                </span>
                                                <?php echo e($studentDetails->class->pass_mark); ?>
            ...
            <table class="table border_table gray_header_table mb-0">
                 ...
                 <?php endif; ?>
                  ...
                  <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignsubject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                              <td ><?php echo e(@$assignsubject->subject->subject_name); ?></td>
                              <?php if(count($result_setting)): ?>
                              ...
                              <?php else: ?> 
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                             <?php endif; ?>
                              <td><?php echo e(subjectAverageMark($record_id,$assignsubject->subject->id)[0]); ?></td>
                              <td></td>
                              <td><?php echo e(getGrade(subjectAverageMark($record_id,$assignsubject->subject->id)[0],true)); ?></td>
                        </tr>
                  ...
                  <tfoot>
                        <tr>
                              <th><?php echo app('translator')->get('exam.total_average'); ?></th>
                              <th></th>
                              <th><?php echo e($studentDetails->class->pass_mark); ?></th>
                              <?php if(count($result_setting)): ?>
                             ...
                             <?php else: ?>
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                             <?php endif; ?> 
                              <th><?php echo e(allExamSubjectMarkAverage($record_id,$all_subject_ids)); ?></th>
                              <th>
                              ...
                              <th><?php echo e(getGrade(allExamSubjectMarkAverage($record_id, $all_subject_ids),true)); ?></th>
                        </tr>
                  </tfoot>
            </table>
      </div>
...
<?php /**PATH C:\xampp\htdocs\resources\views\backEnd\examination\studentFinalMarkSheetPrint.blade.php ENDPATH**/ ?>