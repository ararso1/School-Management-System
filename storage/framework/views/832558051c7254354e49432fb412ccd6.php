                ...
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="news-item">
                                <div class="news-img">
                                    <img class="img-fluid w-100" src="<?php echo e(asset('public/backEnd/img/client/news/news3.jpg')); ?>" alt="">
                                </div>
                                <div class="news-text">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="news-item">
                                <div class="news-img">
                                    <img class="img-fluid w-100" src="<?php echo e(asset('public/backEnd/img/client/news/news4.jpg')); ?>" alt="">
                                </div>
                                <div class="news-text">
                                    <p class="date">17th Nov, 2018</p>
                                    <h4>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="news-item">
                                <div class="news-img">
                                    <img class="img-fluid w-100" src="<?php echo e(asset('public/backEnd/img/client/news/news5.jpg')); ?>" alt="">
                                </div>
                                <div class="news-text">
                                    <p class="date">17th Nov, 2018</p>
                                    <h4>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="news-item">
                                <div class="news-img">
                                    <img class="img-fluid w-100" src="<?php echo e(asset('public/backEnd/img/client/news/news6.jpg')); ?>" alt="">
                                </div>
                                <div class="news-text">
                                    <p class="date">17th Nov, 2018</p>
                                    <h4>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="news-item">
                                <div class="news-img">
                                    <img class="img-fluid w-100" src="<?php echo e(asset('public/backEnd/img/client/news/news7.jpg')); ?>" alt="">
                                </div>
                                <div class="news-text">
                                    <p class="date">17th Nov, 2018</p>
                                    <h4>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="news-item">
                                <div class="news-img">
                                    <img class="img-fluid w-100" src="<?php echo e(asset('public/backEnd/img/client/news/news8.jpg')); ?>" alt="">
                                </div>
                                <div class="news-text">
                                    <p class="date">17th Nov, 2018</p>
                                    <h4>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="news-item">
                                <div class="news-img">
                                    <img class="img-fluid w-100" src="<?php echo e(asset('public/backEnd/img/client/news/news9.jpg')); ?>" alt="">
                                </div>
                                <div class="news-text">
                                    <p class="date">17th Nov, 2018</p>
                                    <h4>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="news-item">
                                <div class="news-img">
                                    <img class="img-fluid w-100" src="<?php echo e(asset('public/backEnd/img/client/news/news10.jpg')); ?>" alt="">
                                </div>
                                <div class="news-text">
                                    <p class="date">17th Nov, 2018</p>
                                    <h4>
...
<?php /**PATH C:\xampp\htdocs\resources\views\frontEnd\home\dark_news.blade.php ENDPATH**/ ?>