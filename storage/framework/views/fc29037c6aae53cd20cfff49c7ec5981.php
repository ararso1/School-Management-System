                                ...
                                <?php else: ?>
                                    <?php if(userPermission('get-backup-files')): ?>
                                        <a href="<?php echo e(route('get-backup-files', 1)); ?>"
                                            ...
                                            <?php echo app('translator')->get('system_settings.generate_file_backup'); ?>
                                        </a>
                                    <?php endif; ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views/backEnd/systemSettings/backupSettings.blade.php ENDPATH**/ ?>