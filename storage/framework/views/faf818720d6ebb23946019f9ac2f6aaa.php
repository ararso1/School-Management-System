                        ...
                        <div class="d-flex radio-btn-flex ml-30">
                            <div class="mr-20 mt-10">
                                <input type="radio" name="set_auth" id="set_auth_on" value="header"
                                    ...
                                    <?php if(!isset($editData) || (isset($editData) && $editData->set_auth == 'header')): ?> checked <?php endif; ?>>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\school\resources\views/backEnd/systemSettings/includes/customSmsSetting.blade.php ENDPATH**/ ?>