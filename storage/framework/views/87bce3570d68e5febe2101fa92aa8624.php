        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        <?php if(isset($designation)): ?>
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => ['designation-update', $designation->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data'])); ?>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mt-40 d-flex justify-content-between">
                                                            ...
                                                            <?php echo e(Form::open(['route' => ['designation-delete', $designation->id], 'method' => 'DELETE', 'enctype' => 'multipart/form-data'])); ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\backEnd\humanResource\designation.blade.php ENDPATH**/ ?>