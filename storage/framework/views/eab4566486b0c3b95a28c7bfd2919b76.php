                ...
                <?php if(userPermission(266)): ?>
                    <div class="row">
                        <div class="offset-lg-10 col-lg-2 text-right col-md-12 mb-20">
                            <a href="<?php echo e(route('global_section')); ?>" class="primary-btn small fix-gr-bg">
                ...
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <?php if(isset($section)): ?>
                                <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'global_section_update', 'method' => 'POST'])); ?>

                            <?php else: ?>
                                <?php if(userPermission(266)): ?>
                                    <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'global_section_store', 'method' => 'POST'])); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label for="levelText"><?php echo app('translator')->get('common.name'); ?> <span>*</span></label>
                                                <input
                ...
                <div class="col-lg-9">
                    <div class="row">
                        <div class="col-lg-4 no-gutters">
                            <div class="main-title">
                                <h3 class="mb-0"><?php echo app('translator')->get('academics.section_list'); ?></h3>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mt-40 d-flex justify-content-between">
                                                                ...
                                                                <a href="<?php echo e(route('global_section_delete', [@$section->id])); ?>"
                                                                    class="text-light">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\backEnd\global\global_section.blade.php ENDPATH**/ ?>