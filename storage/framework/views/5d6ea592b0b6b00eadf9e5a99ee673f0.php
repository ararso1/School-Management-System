    ...
    <section class="sms-breadcrumb mb-20">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1><?php echo e($student_detail->full_name); ?> - <?php echo app('translator')->get('downloadCenter.content_list'); ?> </h1>
                <div class="bc-pages">
                    <a href="<?php echo e(route('dashboard')); ?>"><?php echo app('translator')->get('common.dashboard'); ?></a>
                    <a href="#"><?php echo app('translator')->get('downloadCenter.content_list'); ?></a>
                </div>
            </div>
        </div>
    </section>
    <?php if(isset($sharedContents)): ?>
        <section class="mt-20">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Modules\DownloadCenter\Resources\views\contentShareList\parentContentShareList.blade.php ENDPATH**/ ?>