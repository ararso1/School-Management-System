    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="<?php echo e(route('student_online_exam')); ?>"><?php echo app('translator')->get('exam.online_exam'); ?></a>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-30"><?php echo app('translator')->get('exam.take_online_exam'); ?></h3>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="">
                                    <div class="row  pl-10">
                                        <div class="col-lg-7 mt-20">
                                            <h3><?php echo app('translator')->get('exam.exam_name'); ?> : <?php echo e(@$online_exam->title); ?></h3>
                                                        <h4><strong><?php echo app('translator')->get('common.subject'); ?> : </strong><?php echo e(@$online_exam->subject !=""?@$online_exam->subject->subject_name:""); ?></h4>
                                                        <h4><strong><?php echo app('translator')->get('common.class_Sec'); ?> : </strong><?php echo e(@$online_exam->class !=""?@$online_exam->class->class_name:""); ?> (<?php echo e(@$online_exam->section !=""?@$online_exam->section->section_name:""); ?>)</h4>
                                                        <h4 class="mb-20"><strong><?php echo app('translator')->get('exam.total_marks'); ?> : </strong>
                                                        <?php
                                                        @$total_marks = 0;
                                                            ...
                                                            echo @$total_marks;
                                                        ?></h4>
                                        <p><strong><?php echo app('translator')->get('exam.instruction'); ?> : </strong><?php echo e(@$online_exam->instruction); ?></p>
                                        </div>
                                        <div class="col-lg-5 mt-20">
                                            <p class="mb-2"><strong><?php echo app('translator')->get('exam.exam_has_to_be_submitted_within'); ?>: </strong><?php echo e(@$online_exam->date); ?> <?php echo e(@$online_exam->end_time); ?></p>
                                        ...
                                        <tr>
                                            <td width="80%" class="pt-5">
                                                ...
                                                <?php if(@$question->questionBank->type == "M"): ?>
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-center">
                                                        ...
                                                        <div class="mt-20 mr-20">
                                                            <input data-question="<?php echo e(@$question->question_bank_id); ?>" type="checkbox" id="answer<?php echo e(@$multiple_option->id); ?>" class="common-checkbox answer_question_mu" name="options_<?php echo e(@$question->question_bank_id); ?>[]" value="<?php echo e($multiple_option->id); ?>" <?php echo e($multiple_option->status ? 'checked' : ''); ?>>
                                                ...
                                                <?php elseif($question->questionBank->type == "T"): ?>
                                                    <?php
                                                        $trueFalseAnswer = @$question->questionBank->trueFalse; 
                                                    ?>
                                                    <div class="d-flex align-items-center justify-content-center radio-btn-flex mt-20">
                                                        <div class="mr-30">
                                                            <input data-question="<?php echo e(@$question->question_bank_id); ?>" 
                                                                type="radio" 
                                                                name="trueOrFalse_<?php echo e(@$question->question_bank_id); ?>" 
                                                                id="true_<?php echo e(@$question->question_bank_id); ?>" 
                                                                value="T"  
                                                                class="common-radio relationButton answer_question_mu"
                                                                <?php echo e($trueFalseAnswer == "T" ? 'checked' : ''); ?>>
                                                        ...
                                                        <div class="mr-30">
                                                            <input data-question="<?php echo e(@$question->question_bank_id); ?>" 
                                                                type="radio" 
                                                                name="trueOrFalse_<?php echo e(@$question->question_bank_id); ?>" 
                                                                id="false_<?php echo e(@$question->question_bank_id); ?>" 
                                                                value="F"  
                                                                class="common-radio relationButton answer_question_mu"
                                                                <?php echo e($trueFalseAnswer == "F" ? 'checked' : ''); ?>>
                                                ...
                                                <div class="mt-20">
                                                    ...
                                                    ?>
                                                    <h4>[<?php echo app('translator')->get('exam.currect_answer'); ?>: <?php echo e($currect_multiple); ?>]</h4>
                                                    ...
                                                    <?php
                                                        ...
                                                        $k = 0;
                                                    ?>
                                                    <h4>[<?php echo app('translator')->get('exam.currect_answer'); ?>]</h4>
                                                    ...
                                                    <?php elseif(@$question->questionBank->type == "T"): ?>
                                                        <h4>[<?php echo app('translator')->get('exam.currect_answer'); ?>: <?php echo e(@$question->questionBank->trueFalse == "T"? 'True': 'False'); ?>]</h4>
                                                    <?php else: ?> 
                                                        <h4>[<?php echo app('translator')->get('exam.currect_answer'); ?>: <?php echo e(@$question->questionBank->suitable_words); ?>]</h4>
                                                    <?php endif; ?>
                                                </div>
                                            </td>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\backEnd\examination\view_online_question.blade.php ENDPATH**/ ?>