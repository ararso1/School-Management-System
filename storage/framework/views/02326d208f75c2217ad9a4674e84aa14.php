...
<section class="admin-visitor-area up_admin_visitor">
    <div class="container-fluid p-0">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'student-current-search-with-exam', 'method' => 'GET', 'enctype' => 'multipart/form-data', 'id' => 'search_promoteA'])); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    ...
                                    <select class="primary_select  form-control<?php echo e($errors->has('promote_session') ? ' is-invalid' : ''); ?>" name="promote_session" id="promote_session">
                                ...
                                <div class="col-lg-3 mt-30-md" id="sectionStudentDiv">
                                    <select class="primary_select  form-control<?php echo e($errors->has('section') ? ' is-invalid' : ''); ?>" id="sectionSelectStudent"  name="current_section">
        ...
        <div class="container-fluid p-0">
            <div class="row mt-40">
                <div class="col-lg-12">
                        ...
                        <div class="col-lg-12 no-gutters">
                            <div class="main-title">
                                <h3 class="mb-30"><?php echo app('translator')->get('student.promote'); ?> | 
                                    <small>
                                        <?php echo app('translator')->get('common.academic_year'); ?> : <?php echo e($search_current_academic_year !='' ? $search_current_academic_year->year .'['. $search_current_academic_year->title .']' :''); ?>,
                                        ...
                                        <?php echo app('translator')->get('exam.exam'); ?>: <?php echo e($search_exams !='' ? $search_exams : ' '); ?>,
                    ...
                    <input type="hidden" name="pre_class" value="<?php echo e($current_class); ?>">
                    <input type="hidden" name="pre_section" value="<?php echo e($current_section); ?>">
                            ...
                            <table class="table school-table-style" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo app('translator')->get('common.class_section'); ?>)</th>                                                                        
                                ...
                                <tbody>
                                  ...
                                  <input type="hidden" name="promote[<?php echo e($student->studentinfo->id); ?>][result]"  value="<?php echo e($student->result); ?>">
                                    
                                    <tr>
                                        <td>
                                            <input type="checkbox" id="student_<?php echo e($student->studentinfo->id); ?>" class="common-checkbox promote_check" name="promote[<?php echo e($student->studentinfo->id); ?>][student]" value="<?php echo e($student->studentinfo->id); ?>">
                                            <label for="student_<?php echo e($student->studentinfo->id); ?>"></label>
                                        </td>
                                        <td> <a href="<?php echo e(route('student_view',[$student->studentinfo->id])); ?>"  target="_blank" rel="noopener noreferrer">  <h5 style="color:#A235EC"><?php echo e($student->studentinfo->roll_no); ?></h5></a> </td>
                                        <td><?php echo e($student->studentinfo->first_name .' '.$student->studentinfo->last_name); ?></td>
                                       <td><?php echo e($student->total_marks); ?></td>
                                       <td><?php echo e($student->gpa_point); ?></td>
                                       <td><?php echo e($student->result); ?></td>
                                       <td><?php echo e($key+1); ?></td>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                              ...
                                              <select class="primary_select form-control <?php echo e($errors->has('class') ? ' is-invalid' : ''); ?> promote_class" id="promote_class" name="promote[<?php echo e($student->studentinfo->id); ?>][class]">
                                        ...
                                        <td>
                                           ...
                                           <div class="row">
                                            ...
                                            <div class="col-lg-12" id="promote_section_div">
                                               ...
                                               <select class="primary_select form-control<?php echo e($errors->has('section') ? ' is-invalid' : ''); ?> promote_section" id="promote_section"   name="promote[<?php echo e($student->studentinfo->id); ?>][section]">
                                                ...
                                                <option data-display="<?php echo app('translator')->get('common.select_section'); ?> *" value=""><?php echo app('translator')->get('common.select_section'); ?> *
                                                 ...
                                                 <?php if($next_class): ?>
                                                    <?php $__currentLoopData = $next_class->classSection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <td> 
                                            <div class="row">
                                                <div class="col-lg-12"> 
                                                    ...
                                                    <input class="primary_input_field form-control<?php echo e(@$errors->has('name') ? ' is-invalid' : ''); ?> promote_roll_number" type="number" name="promote[<?php echo e($student->studentinfo->id); ?>][roll_number]" autocomplete="off" >
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\backEnd\studentInformation\student_promote_with_exam.blade.php ENDPATH**/ ?>