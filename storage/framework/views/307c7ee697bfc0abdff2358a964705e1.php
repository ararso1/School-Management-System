        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="student-meta-box">
                    ...
                    <img class="student-meta-img img-100" src="<?php echo e(asset('public/backEnd/img/student/student-meta-img.png')); ?>" alt="">
                    <div class="white-box">
                        <div class="row">
                            <div class="col-lg-8">
                        ...
                        <tbody class="d-block">
                            <tr class="d-block">
                                <td width="100%" class="pr-30 d-block">
                                    <div class="primary_input mt-10">
                                        <input class="primary_input_field form-control" type="text" id="basicSalary">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\frontEnd\human_resource_payroll_generate.blade.php ENDPATH**/ ?>