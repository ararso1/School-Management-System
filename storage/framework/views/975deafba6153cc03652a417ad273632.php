    ...
    <table cellspacing="0" width="100%">
        <tr>
            ...
            <td style="text-aligh:center">
                <p style="font-size:14px !important; border-bottom:1px solid gray" alaign="left"
                   class="text-white"><?php echo app('translator')->get('common.name'); ?>: <?php echo e($student_detail->full_name); ?> </p>
                <p style="font-size:14px !important; border-bottom:1px solid gray" alaign="left"
                   class="text-white"><?php echo app('translator')->get('student.month'); ?>: <?php echo e(date("F", strtotime('00-'.$month.'-01'))); ?> </p>
                <p style="font-size:14px !important; border-bottom:1px solid gray" alaign="left"
                   class="text-white"><?php echo app('translator')->get('student.year'); ?>: <?php echo e($year); ?> </p>
...
<?php /**PATH C:\xampp\htdocs\resources\views\backEnd\parentPanel\attendance_print.blade.php ENDPATH**/ ?>