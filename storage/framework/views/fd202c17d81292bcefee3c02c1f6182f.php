                ...
                <div class="col-md-12">
                    <form method="post" action="<?php echo e(route('service.license')); ?>" id="content_form">
                        <div class="form-group">
                            <label class="required" for="access_code"><?php echo e(__('service::install.access_code')); ?> | Random value</label>
                            <input type="text" class="form-control " name="access_code" id="access_code"  required="required" autofocus="" value="<?php echo e(old('access_code', request('access_code'))); ?>"  placeholder="<?php echo e(__('service::install.access_code')); ?>" >
                            <?php if(request('message')): ?>
                                <span class="text-danger"><?php echo e(request('message')); ?></span>
                            <?php endif; ?>
                        </div>
                        <div class="form-group">
                            <label class="required" for="envato_email"><?php echo e(__('service::install.envato_email')); ?></label>
                            <input type="email" class="form-control" name="envato_email" id="envato_email" value="<?php echo e(old('envato_email', request('envato_email'))); ?>" required="required" placeholder="<?php echo e(__('service::install.envato_email')); ?>" >
                        </div>
...
<?php echo $__env->make('service::layouts.app_install', ['title' => __('service::install.license')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\school-mgt\resources\/views/vendors/service/install/license.blade.php ENDPATH**/ ?>