				...
				<div class="col-lg-5 col-md-8">
					<div class="text-center">
						<div class="logo-container">
							<a href="#">
								<img src="<?php echo e(asset('public/backEnd/img/400.png')); ?>" alt="" width="100%">
							</a>
						</div>
						...
						<div class="form-group mt-50 mb-30">
							<a href="<?php echo e(route('login')); ?>" class="primary-btn fix-gr-bg">
								Back To Home
                            </a>
						</div>
					</div>
...
<?php /**PATH C:\xampp\htdocs\resources\views\auth\error.blade.php ENDPATH**/ ?>