...
<section class="sms-breadcrumb mb-20">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('study.others_download'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(route('dashboard')); ?>"><?php echo app('translator')->get('common.dashboard'); ?></a>
                <a href="#"><?php echo app('translator')->get('study.study_material'); ?></a>
                <a href="#"><?php echo app('translator')->get('study.others_download'); ?></a>
            </div>
        </div>
    </div>
</section>
...
<?php $component->withAttributes([]); ?>
                                                                ...
                                                                <?php if(@$value->upload_file != ""): ?>
                                                                    <?php if(userPermission("student_others_download")): ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\backEnd\studentPanel\othersDownload.blade.php ENDPATH**/ ?>