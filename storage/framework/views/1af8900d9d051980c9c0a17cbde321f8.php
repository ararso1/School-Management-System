                    ...
                    <form class="row contact_form mt-50" action="#" method="post" id="contactForm" novalidate="novalidate">
                        <div class="col-lg-12">
                            <div class="primary_input">
                                <input class="primary_input_field form-control" placeholder="Enter your name" type="text" id="">
                            ...
                            <div class="primary_input mt-20">
                                <input class="primary_input_field form-control" placeholder="Enter Subject" type="text" id="">
                                
                            </div>
                            <div class="primary_input mt-20">
                                <textarea class="primary_input_field form-control" placeholder="Enter Message" cols="0" rows="4"></textarea>
...
<script src="<?php echo e(asset('public/backEnd/')); ?>/vendors/js/gmaps.min.js"></script>
...
<?php /**PATH C:\xampp\htdocs\resources\views\frontEnd\home\dark_contact.blade.php ENDPATH**/ ?>