            ...
            <div class="card-body">
               ...
               <form method="post" action="<?php echo e(url('check-verified-input')); ?>">
                   ...
                   <div class="form-group">
                       ...
                       <input type="text" class="form-control" name="code" required="required" placeholder="Enter Your Purchase Code" value="<?php echo e(old('purchasecode')); ?>">
                   </div>
                   <div class="form-group">
                       <label for="domain">Installation Domain:</label>
                       <input type="text" class="form-control" name="domain" required="required" value="<?php echo e(url('/')); ?>">
                   </div>
...
<?php /**PATH C:\xampp\htdocs\resources\views\install\ProModuleverify.blade.php ENDPATH**/ ?>