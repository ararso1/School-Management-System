                        ...
                        <div class="invoice_part_iner">
                            ...
                            <table class="table">
                                ...
                                <td>
                                    <p class="line_grid" >
                                                            <span>
                                                                <span><?php echo app('translator')->get('common.search'); ?></span><span>:</span>
                                                            </span>
                            ...
                            <tr>
                                <td>
                                    <p class="line_grid" >
                                                            <span>
                                                                <span><?php echo app('translator')->get('student.roll_no'); ?></span><span>:</span>
                                                            </span>
                            ...
                            <tr>
                                ...
                                <?php if($optional_subject_setup!=''): ?>
                                    ...
                                    <td>
                                        ...
                                        <?php if(isset($this_student_failed) && $this_student_failed==1): ?>
                                            <span class="text-warning font-weight-bold"><?php echo e($fail_grade_name->grade_name); ?></span>
                                        <?php else: ?>
                                            <?php
                                                if($number >= $max_grade){
            ...
            <table class="table border_table gray_header_table mb-0" >
                <thead>
                    ...
                    <tr>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php if($optional_subject_setup!=''): ?>
                            <th><small><?php echo app('translator')->get('exam.without_additional'); ?></small></th>
                        <?php endif; ?>
                    </tr>
                </thead>
                <tbody>
                                ...
                                <td>
                                    <div class="logo_img">
                                        <div class="logo_thumb_upper">
                                            ...
                                            <h2>
                                                <?php echo app('translator')->get('common.search'); ?> : <?php echo e($tabulation_details['class']); ?>
                                        ...
                                        <div class="company_info">
                                            <h3><?php echo e(isset(generalSetting()->school_name)?generalSetting()->school_name:'Infix School Management ERP'); ?></h3>
                                            <h5><?php echo e(isset(generalSetting()->address)?generalSetting()->address:'Infix School Address'); ?></h5>
                                            <h5><?php echo app('translator')->get('exam.email'); ?>: <?php echo e(isset(generalSetting()->email)?generalSetting()->email:'hello@aorasoft.com'); ?>, <?php echo app('translator')->get('exam.phone'); ?>: <?php echo e(isset(generalSetting()->phone)?generalSetting()->phone:'+96897002784 '); ?></h5>
                        </div>
                        <div class="invoice_wrapper fullwidth_90">
                            <div class="invoice_print mb_30">
                                <div class="container">
                            ...
                            <div class="table_title" style="margin-bottom: 20px; text-align: center">
                                <h3>
                                    <?php echo app('translator')->get('exam.tabulation_sheet'); ?> <?php echo app('translator')->get('exam.of'); ?> <?php echo e($tabulation_details['exam_term']); ?> <?php echo app('translator')->get('exam.in'); ?> <?php echo e($year); ?>
                            ...
                            <table class="table border_table gray_header_table mb-0" >
                                <thead>
                                    <tr>
                                        <th rowspan="3"><?php echo app('translator')->get('common.name'); ?></th>
                                        <th rowspan="3"><?php echo app('translator')->get('student.roll_no'); ?></th>
                                            <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php
                                                    $subject_ID     = $subject->subject_id;
                                                    $subject_Name   = $subject->subject->subject_name;
                                            ...
                                            <?php if($optional_subject_setup!=''): ?>
                                                ...
                                                <th rowspan="2"><?php echo app('translator')->get('reports.result'); ?></th>
                                            <?php else: ?>
                                                <th colspan="1" rowspan="3"> <?php echo app('translator')->get('exam.gpa'); ?></th>
                                            <?php endif; ?>
                                    </tr>
                                    <tr>
                                    <?php if($optional_subject_setup!=''): ?>
...
<?php /**PATH C:\xampp\htdocs\resources\views\backEnd\reports\tabulation_sheet_report_print_lang.blade.php ENDPATH**/ ?>