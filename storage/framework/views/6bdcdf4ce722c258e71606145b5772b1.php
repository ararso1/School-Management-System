                        ...
                        <div class="white-box">
                            ...
                            <div class="add-visitor">
                                    ...
                                    <div class="col-md-12">
                                        <div class="primary_input">
                                            ...
                                            <?php if($errors->has('outline')): ?>
                                                <span class="error text-danger"><?php echo e($errors->first('outline')); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="primary_input">
                                            ...
                                            <?php if($errors->has('prerequisites')): ?>
                                                <span class="error text-danger"><?php echo e($errors->first('prerequisites')); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-15">
                                    <div class="col-md-12">
                                        <div class="primary_input">
                                            <label class="primary_input_label d-flex" for=""><?php echo app('translator')->get('front_settings.resources'); ?>
                                                <?php if(moduleStatusCheck('AiContent')): ?>
                                                    <?php echo $__env->make('aicontent::inc.button', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                <?php endif; ?>
                                            </label>
                                            ...
                                            <?php if($errors->has('resources')): ?>
                                                <span class="error text-danger"><?php echo e($errors->first('resources')); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-15">
                                    <div class="col-md-12">
                                        <div class="primary_input">
                                            <label class="primary_input_label d-flex" for=""><?php echo app('translator')->get('front_settings.stats'); ?>
                                                <?php if(moduleStatusCheck('AiContent')): ?>
                                                    <?php echo $__env->make('aicontent::inc.button', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                <?php endif; ?>
                                            </label>
                                            ...
                                            <?php if($errors->has('stats')): ?>
                                                <span class="error text-danger"><?php echo e($errors->first('stats')); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\backEnd\frontSettings\course\course_page.blade.php ENDPATH**/ ?>