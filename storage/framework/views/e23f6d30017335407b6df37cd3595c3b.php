                ...
                <div class="row">
                            ...
                            <div class="col-lg-4 mt-30-md">
                                ...
                                <select class="primary_select" name="output">
                                    <option value="print" <?php echo e(old('output', 'print') == 'print' ? 'selected' : ''); ?>>Preview / Print</option>
                                    <option value="pdf" <?php echo e(old('output') == 'pdf' ? 'selected' : ''); ?>>Export as PDF</option>
                                </select>
                            </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\school-mgt\resources\views/backEnd/admin/idCard/generate_id_card.blade.php ENDPATH**/ ?>