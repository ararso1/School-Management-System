    ...
    <section class="sms-breadcrumb mb-20">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1><?php echo e($student_detail->full_name); ?> - <?php echo app('translator')->get('lesson::lesson.lesson_plan'); ?> </h1>
                <div class="bc-pages">
                                                    ...
                                                    <div class="col-lg-12 col-md-12">
                                                        <div class="main-title">
                                                            ...
                                                            <h3 class="text-center "><a
                                                                    href="<?php echo e(url('/lesson/parent/dicrease-week/' . $student_detail->id . '/' . $dates[0])); ?>">
                                                                    < </a> week <?php echo e($week_number); ?> | <span class="yearColor">
                                                                            <?php echo e(date('Y', strtotime($dates[0]))); ?> </span> <a
                                                                            href="<?php echo e(url('/lesson/parent/change-week/' . $student_detail->id . '/' . $dates[6])); ?>">
                                                                            > </a></h3>
                                                                ...
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <?php $__currentLoopData = $sm_weekends; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $sm_weekend): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            ...
                                                                            ?>
                                                                            <?php if($parentRoutine->count() > $height): ?>
                                                                                <?php
                                                                ...
                                                                <?php $__currentLoopData = $sm_weekends; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sm_weekend): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <?php
                                                                      if(moduleStatusCheck('University'))
                                                                        ...
                                                                        $i = 0;
                                                                    ?>
                                                                    <?php $__currentLoopData = $parentRoutine; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $routine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <?php
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Modules\Lesson\Resources\views\parent\parent_lesson_plan.blade.php ENDPATH**/ ?>