         ...
         <div class="col-lg-3">
           ...
           <div class="single-meta">
            <div class="d-flex justify-content-between">
                ...
                <div class="value">
                    <?php if(isset($staffDetails)): ?><?php echo e($staffDetails->basic_salary); ?><?php endif; ?>
                </div>
            </div>
        </div>
        <div class="single-meta">
...
<div class="col-lg-9 staff-details">
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li class="nav-item edit-button">
            <a href="<?php echo e(route('editStaff',$staffDetails->id)); ?>" class="primary-btn small fix-gr-bg"><?php echo app('translator')->get('common.edit'); ?>
            </a>
        </li>
    </ul>
    ...
    <div class="tab-content">
        ...
        <div class="single-info">
            <div class="row">
                ...
                <div class="col-lg-7 col-md-7">
                    <div class="">
                        <?php if(isset($staffDetails)): ?><?php echo e($staffDetails->gender); ?><?php endif; ?> 
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="white-box">
        ...
        <thead>
            <tr>
                ...
                <th width="15%">Net Salary(<?php echo e(generalSetting()->currency_symbol); ?>)</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <?php if($value->payroll_status == 'P'): ?>
                    <a class="modalLink" data-modal-size="modal-lg" title="View Payslip Details" href="<?php echo e(route('view-payslip', $value->id)); ?>"><button class="primary-btn small tr-bg"> View Payslip</button></a>
                    <?php endif; ?>
                </td>
            </tr>
                ...
                <table id="table_id" class="table" cellspacing="0" width="100%">
                    ...
                    <tbody>
                       ...
                       <tr>
                        ...
                        <td>
                            <a class="modalLink" data-modal-size="modal-md" title="View Leave Details" href="<?php echo e(route('view-leave-details', $value->id)); ?>"><button class="primary-btn small tr-bg"> View </button></a>
                        </td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php else: ?> 
        ...
        cellspacing="0">
            ...
            <tbody class="d-block">
                ...
                <tr class="d-flex">
                    ...
                    <td class="col-4">
                        <a href="<?php echo e(route('download-staff-joining-letter',getFilePath3($staffDetails->joining_letter))); ?>">
                ...
                <tr class="d-flex">
                    ...
                    <td class="col-4">
                        <a href="<?php echo e(route('download-resume',getFilePath3($staffDetails->resume))); ?>">
                            <button class="primary-btn tr-bg text-uppercase bord-rad">
                                Download
                                <span class="pl ti-download"></span>
                            </button>
                ...
                <tr class="d-flex">
                    ...
                    <td class="col-4">
                        <a href="<?php echo e(route('download-other-document',getFilePath3($staffDetails->other_document))); ?>">
                            <button class="primary-btn tr-bg text-uppercase bord-rad">
                                Download
                                <span class="pl ti-download"></span>
                            </button>
                ...
                <tr class="d-flex">
                    ...
                    <td class="col-4">
                        <a class="primary-btn tr-bg text-uppercase bord-rad" href="<?php echo e(route('download-staff-document',getFilePath3($value->file))); ?>">
                            Download
                                <span class="pl ti-download"></span>
                        </a>
                        <a class="primary-btn icon-only fix-gr-bg modalLink" title="Delete Document" data-modal-size="modal-md"  href="<?php echo e(route('delete-staff-document-view',$value->id)); ?>">
                                    ...
                                    <div class="row no-gutters input-right-icon mt-35">
                                        ...
                                        <div class="col-auto">
                                            <button class="primary-btn-small-input" type="button">
                                                ...
                                                <input type="file" class="d-none" id="browseFile" name="staff_upload_document">
                                            </button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="single-activity">
                            ...
                            <div class="sub-activity-box d-flex">
                                <h6 class="time text-uppercase">                                                                            
                                     <?php echo e($timeline->created_at != ""? dateConvert($timeline->created_at):''); ?>
                                ...
                                <div class="close-activity">
                                    ...
                                    <a href="<?php echo e(route('download-staff-timeline-doc',getFilePath3($timeline->file))); ?>" class="primary-btn tr-bg text-uppercase bord-rad">
                             ...
                             <div class="row">
                                ...
                                <div class="col-lg-12 mt-30">
                                    <div class="no-gutters input-right-icon">
                                        <div class="col">
                                            <div class="primary_input">
                                                <input class="primary_input_field  primary_input_field date form-control form-control<?php echo e($errors->has('date_of_birth') ? ' is-invalid' : ''); ?>" id="startDate" type="text"
                                                name="date" autocomplete="off" value="<?php echo e(date('m/d/Y')); ?>">
                                ...
                                <div class="col-lg-12 mt-30">
                                    <div class="row no-gutters input-right-icon mt-35">
                                        <div class="col">
                                            <div class="primary_input">
                                                <input class="primary_input_field" id="placeholderFileFourName" type="text"
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\frontEnd\viewStaff.blade.php ENDPATH**/ ?>