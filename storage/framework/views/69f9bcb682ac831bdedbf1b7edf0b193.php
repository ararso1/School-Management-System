        ...
        <div class="<?php echo e((resultPrintStatus('body'))? "meritTableBody": "meritTableBodyCustomReport"); ?>">
            ...
            <table class="align-center table border_table gray_header_table mb-0 ">
                ...
                <?php $__currentLoopData = $mark_sheet; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    ?>
                    <tr>
                        <th colspan="1"><?php echo e($data->subject->subject_name); ?></th>
                        <td>
                            <?php if(@generalSetting()->result_type == 'mark'): ?>
                ...
                <?php if(count($remainSubjects) > 0): ?>
                    <?php $__currentLoopData = $remainSubjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reaminSubject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <tr>
                            <td colspan="1"><?php echo e($subject->subject_name); ?></td>
                            <td>-</td>
                            <td>-</td>
                            <td>-</td>
                            <td>-</td>
            ...
            <table class="table border_table gray_header_table mb_30 max-width-400 ml_auto margin-auto report_table <?php if(resultPrintStatus('vertical_boarder')): ?> mt_40 <?php endif; ?>">
                <tbody>
                <tr>
                    <td><?php echo app('translator')->get('exam.attendance'); ?></td>
                    <td><?php echo e(@$student_attendance); ?> <?php echo app('translator')->get('exam.of'); ?> <?php echo e(@$total_class_days); ?></td>
                ...
                <?php endif; ?>
                <tr>
                    <td class="nowrap <?php echo e(generalSetting()->result_type == 'mark' ? 'text-center' : ''); ?>" colspan="<?php echo e(generalSetting()->result_type == 'mark' ? '2' : ''); ?>"><?php echo app('translator')->get('reports.average_mark'); ?></td>
                    <td colspan="<?php echo e(generalSetting()->result_type == 'mark' ? '2' : ''); ?>">
                        <?php
                            $average_mark=$total_mark/$Optional_subject_count;
                        ?>
                ...
                <?php if(@generalSetting()->result_type != 'mark'): ?>
                    ...
                    <tr>
                        ...
                        <td colspan="2"
                            style="text-align: center !important;"><?php echo e(getStudentMeritPosition($class_id, $section_id, $exam_details->id, $student_detail->id)); ?></td>
                    </tr>
                <?php endif; ?>
                </tbody>
            </table>
...
</html><?php /**PATH C:\xampp\htdocs\resources\views\backEnd\reports\mark_sheet_report_normal_print.blade.php ENDPATH**/ ?>