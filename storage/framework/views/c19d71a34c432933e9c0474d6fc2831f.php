<?php $__env->startPush('css'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('public/backEnd/assets/vendors/css/customFullCalendar.css')); ?>" />
    <style>
        .color-input {
            height: 50px;
...
<?php $__env->startPush('script'); ?>
    <script src="<?php echo e(asset('public/backEnd/')); ?>/full_calendar/js/index.global.min.js"></script>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var calendarEl = document.getElementById('academicCalendar');
            var eventsData = <?php echo json_encode($events, 15, 512) ?>;
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                initialDate: '<?php echo e(\Carbon\Carbon::now()->format('Y-m-d')); ?>',
                navLinks: true, // can click day/week names to navigate views
                <?php if(userPermission('event-store') && auth()->user()->role_id != $is_alumni): ?>
                    editable: true,
                    selectable: true,
                <?php endif; ?>
                ...
                eventClick: function(event, jsEvent, view) {
                    ...
                    var startEndDate = startDate + ' <?php echo e(__('common.to')); ?> ' + endDate;
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\school-mgt\resources\views/backEnd/communicate/academic_calendar_css_js.blade.php ENDPATH**/ ?>