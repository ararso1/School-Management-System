                ...
                <div class="id_card" id="id_card" style="display: grid !important;grid-template-columns: repeat(3,1fr) !important;grid-gap: 20px;justify-content: center;">
                    <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    			     <table cellpadding="0" cellspacing="0" border="0" width="156" height="241" align="center" style=" border: 1px solid var(--border_color); margin: 0px 0 0 0;" >
                        <tr style="border-right: 1px solid #ddd; border-left: 1px solid #ddd;  height: 0px; ">
                            <td colspan="3" style=" position: relative; text-align: center; background-color: #c738d8; border:1px solid #c738d8">
                               <!--  <center>
                                ...
                                <h3 style="padding: 5px; text-align: center; margin-bottom: 0px; font-size: 12px;  color: #fff; font-family: 'PT Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; "><?php echo app('translator')->get('common.view_student_id_card'); ?></h3>
                            </td>
                        </tr>
                        <tr >
                        ...
                        <tr >
                            <td colspan="2" style="padding-left: 20px; border-left: 1px solid #ddd"><?php echo app('translator')->get('common.name'); ?></td>
                            
                            <td style="text-align: right; margin-right: 40px !important; border-right: 1px solid #ddd"><?php echo e(@$student->full_name); ?></td>
                        </tr >
                        <?php endif; ?>
                        <?php if(!empty($id_card->academic_id)): ?>
                        <tr >
                            <td colspan="2" style="padding-left: 20px; white-space:nowrap; border-left: 1px solid #ddd"><?php echo app('translator')->get('common.academic_year'); ?></td>
                            
                            <td style="text-align: right; margin-right: 40px !important; border-right: 1px solid #ddd"><?php echo e(@$student->academicYear->year); ?> - [<?php echo e(@$student->academicYear->title); ?>]</td>
                        </tr >
                        <?php endif; ?>
                        <?php if(@$id_card->admission_no == 1): ?>
                        <tr >
                            <td colspan="2" style="padding-left: 20px; border-left: 1px solid #ddd"><?php echo app('translator')->get('student.admission_no'); ?></td>
                        ...
                        <tr >
                            <td colspan="2" style="padding-left: 20px; border-left: 1px solid #ddd;"><?php echo app('translator')->get('common.class'); ?></td>                            
                            <td style="text-align: right; margin-right: 40px !important; border-right: 1px solid #ddd">
                                <?php echo e(@$student->class!=""?@$student->class->class_name:""); ?> 
                                (<?php echo e(@$student->section!=""?@$student->section->section_name:""); ?>)</td>
                        </tr>
                        <?php endif; ?>
                        <?php if(@$id_card->father_name == 1): ?>
                        <tr >
                            <td colspan="2" style="padding-left: 20px; border-left: 1px solid #ddd"><?php echo app('translator')->get('student.father_name'); ?></td>                            
                        ...
                        <tr >
                            <td colspan="2" style="padding-left: 20px; white-space:nowrap; border-left: 1px solid #ddd"><?php echo app('translator')->get('student.mother_name'); ?></td>                            
                        ...
                        <tr >
                            <td colspan="2" style="padding-left: 20px; border-left: 1px solid #ddd"><?php echo app('translator')->get('student.student_address'); ?></td>                           
                        ...
                        <tr >
                            <td colspan="2" style="padding-left: 20px; border-left: 1px solid #ddd"><?php echo app('translator')->get('student.blood_group'); ?></td>                           
                        ...
                        <tr >
                            <td colspan="2" style="padding-left: 20px; border-left: 1px solid #ddd"><?php echo app('translator')->get('common.phone'); ?></td>
                        ...
                        <tr >
                            <td colspan="2" style="padding-left: 20px; border-left: 1px solid #ddd"><?php echo app('translator')->get('common.date_of_birth'); ?></td>                            
                            <td style=" border-right: 1px solid #ddd; text-align: right; margin-right: 40px !important;">                              
                                <?php echo e(@dateConvert($student->date_of_birth)); ?>
...
<?php /**PATH C:\xampp\htdocs\resources\views\backEnd\admin\idCard\student_id_card_print_2.blade.php ENDPATH**/ ?>