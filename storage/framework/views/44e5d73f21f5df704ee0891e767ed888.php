                        ...
                        <tr>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="primary_input">
                                            <input class="primary_input_field" type="text" placeholder="Enter Room Number" name="monday_room" value="<?php echo e(isset($class_routine->monday_room_id)? $class_routine->monday_room_id:''); ?>">
                            ...
                            <td>
                                <div class="row">
                                    <div class="col">
                                        <div class="primary_input">
                                            <input class="primary_input_field" type="text" placeholder="Enter Student No" name="monday_room" value="<?php echo e(isset($class_routine->monday_room_id)? $class_routine->monday_room_id:''); ?>">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <table id="" class="table-data school-table" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th>Student Name</th>
                                        <th>Class</th>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\frontEnd\design.blade.php ENDPATH**/ ?>