        ...
        <table class="table school-table-style" cellspacing="0" width="100%">
            ...
            <?php if($payments): ?>
                ...
                <tr>
                    ...
                    <td><button type="button" class="btn btn-danger btn-sm" onclick="delete_sell_payments(<?php echo e($value->id); ?>)"><?php echo app('translator')->get('common.delete'); ?></button></td>
                </tr>
...
<?php /**PATH C:\xampp\htdocs\resources\views\backEnd\inventory\viewSellPayments.blade.php ENDPATH**/ ?>