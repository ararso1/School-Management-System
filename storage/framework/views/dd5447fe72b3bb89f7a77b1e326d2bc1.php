...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset($base_path . '/css/select2.css')); ?>">
...
<body class="admin">
    ...
    <script type="text/javascript" src="<?php echo e(asset($base_path . '/js/select2.min.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\school-mgt\resources\/views/vendors/service/layouts/app_install.blade.php ENDPATH**/ ?>