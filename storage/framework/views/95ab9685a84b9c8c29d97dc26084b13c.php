...
<body>
	<form method="POST" name="customerData" action="<?php echo e(route('cc-ave')); ?>">
          <?php echo csrf_field(); ?>
		<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"><b>Integration Kit</b></font></caption></table>
			<table width="50%" height="100" border='1' align="center">
				<tr>
                         <input type="hidden" name="redirect_url" value="<?php echo e(route('cc-response')); ?>"> 
                         <input type="hidden" name="cancel_url" value="<?php echo e(route('cc-response')); ?>"> 
				...
				<tr>
					<td>Merchant Id	:</td><td><input type="text" name="merchant_id" value="2450530"/></td>
				</tr>
				<tr>
		        ...
		        <tr> <td> Data Accepted At </td>
		         ...
		         <tr> <td> Card Number: </td>
		            <td> <input type="text" id="card_number" name="card_number" value="4111111111111111"/>e.g. 4111111111111111 </td>
		         </tr>
		          <tr> <td> Expiry Month: </td>
		               <td> <input type="text" name="expiry_month" value="07"/>e.g. 07 </td>
		         </tr>
		          <tr> <td> Expiry Year: </td>
		          	   <td> <input type="text" name="expiry_year" value="2027"/>e.g. 2027</td>
		         </tr>
		          <tr> <td> CVV Number:</td>
		               <td> <input type="text" name="cvv_number" value="328"/>e.g. 328</td>
		         </tr>
		         <tr> <td> Issuing Bank:</td>
		            <td><input type="text" name="issuing_bank" value="State Bank Of India"/>e.g. State Bank Of India</td>
		         </tr>
			 <tr> 
				<td> Mobile Number:</td>
		            	<td><input type="text" name="mobile_number" value="9770707070"/>e.g. 9770707070</td>
		         </tr>
			<tr> 
				<td> MMID:</td>
		            	<td><input type="text" name="mm_id" value="1234567"/>e.g. 1234567</td>
		         </tr>
			<tr> 
				<td> OTP:</td>
		            	<td><input type="text" name="otp" value="123456"/>e.g. 123456</td>
		         </tr>
			 <tr> 
				<td> Promotions:</td>
...
<?php /**PATH C:\xampp\htdocs\resources\views\backEnd\global\ccAve.blade.php ENDPATH**/ ?>