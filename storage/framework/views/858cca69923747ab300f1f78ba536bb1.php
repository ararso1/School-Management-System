    ...
    <section class="admin-visitor-area up_admin_visitor empty_table_tab">
        <div class="container-fluid p-0">
          <div class="row mt-40">
               <div class="col-lg-12">
                   <div class="white-box">
                       <form method="post" action="<?php echo e(route('messengerSettingUpdate')); ?>" enctype = 'multipart/form-data'>
                           <?php echo csrf_field(); ?>
                           <div class="row p-0">
                               <div class="col-lg-12">
                                        ...
                                        <div class="col-xl-6 mt-4">
                                             ...
                                             <div class="d-flex radio-btn-flex flex-wrap gap-20">
                                                  <div >
                                                       ...
                                                       <label
                                                            for="relationFather33332"><?php echo e(__('Mobile')); ?></label>
                                                  </div>
                                                  <div >
                                                       <input type="radio" name="availability"
                                                       ...
                                                       <label
                                                            for="relationMother4432"><?php echo e(__('system_settings.only_desktop')); ?></label>
                                                  </div>
                                                  <div >
                                                       <input type="radio" name="availability"
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views/backEnd/systemSettings/plugin_messenger_setting.blade.php ENDPATH**/ ?>