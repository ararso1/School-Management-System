...
<link rel="stylesheet" href="<?php echo e(asset('public/backEnd/css/lms-video.css')); ?>">
<?php $__env->stopPush(); ?>
                            ...
                            <div class="video_palyer_list_wrapper">
                                <div class="infixLms_video_palyer_lists d-flex flex-column postion-relative">
                                    ...
                                    <div class="accordion infixLms_accordian  mb_50 flex-fill" id="accordion_ex">
                                        <?php echo $__env->make('lms.chapter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        <?php echo $__env->make('lms.online_exam', ['level' => 0], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<!--                                        <div class="card">
...
<!-- lms design here -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\lms-design.blade.php ENDPATH**/ ?>