<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('study.other_downloads_list'); ?>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('mainContent'); ?>
    <section class="sms-breadcrumb mb-20">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1><?php echo app('translator')->get('study.other_downloads_list'); ?> </h1>
                <div class="bc-pages">
                    <a href="<?php echo e(route('dashboard')); ?>"><?php echo app('translator')->get('common.dashboard'); ?></a>
                    <a href="#"><?php echo app('translator')->get('study.study_material'); ?></a>
                    <a href="#"><?php echo app('translator')->get('study.other_downloads_list'); ?></a>
                </div>
            </div>
        </div>
    </section>
                        ...
                        <div class="row">
                            <div class="col-lg-4 no-gutters">
                                <div class="main-title">
                                    <h3 class="mb-15"><?php echo app('translator')->get('study.other_downloads_list'); ?></h3>
                                </div>
                            </div>
                        </div>
...
<?php endif; ?>
    ...
    <div class="modal fade admin-query"
        id="deleteOtherDownloadModal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"><?php echo app('translator')->get('study.delete_other_download'); ?></h4>
...
<?php $__env->startPush('script'); ?>
        ...
        $(document).ready(function() {
            $('.data-table').DataTable({
                ...
                "ajax": $.fn.dataTable.pipeline({
                    url: "<?php echo e(route('other-download-list-datatable')); ?>",
                    data: {},
    ...
    <script>
        function deleteOtherDownload(id) {
            var modal = $('#deleteOtherDownloadModal');
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views/backEnd/teacher/otherDownloadList.blade.php ENDPATH**/ ?>