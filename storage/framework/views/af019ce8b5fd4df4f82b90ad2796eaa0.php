...
<section class="admin-visitor-area up_st_admin_visitor">
    <div class="container-fluid p-0">
        <?php if(isset($department)): ?>
         <?php if(userPermission("department-store")): ?>
            ...
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php else: ?>
                         <?php if(userPermission("department-store")): ?>
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'department-store',
                        ...
                        <div class="white-box">
                            <div class="main-title">
                                <h3 class="mb-15"><?php if(isset($department)): ?>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="primary_input">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('hr.department_name'); ?> <span class="text-danger"> *</span></label>
                ...
                <div class="white-box">
                    <div class="row">
                        <div class="col-lg-4 no-gutters">
                            <div class="main-title">
                                <h3 class="mb-15"><?php echo app('translator')->get('hr.department_list'); ?></h3>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views/backEnd/humanResource/human_resource_department.blade.php ENDPATH**/ ?>