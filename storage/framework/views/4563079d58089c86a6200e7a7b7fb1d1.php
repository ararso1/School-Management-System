                            ...
                            <div class="white-box">
                                ...
                                <div class="add-visitor <?php echo e(isset($update)? '':'isDisabled'); ?>">
                                            ...
                                            <div class="primary_input mt-15">
                                                <div class="primary_input">
                                                    <label class="primary_input_label d-flex"
                                                        for=""><?php echo app('translator')->get('common.description'); ?>
                                                    ...
                                                    <textarea class="generated-text primary_input_field form-control" cols="0" rows="5" name="description" id="description"><?php echo e(isset($update) ? ($about_us != '' ? $about_us->description : '') : ''); ?></textarea>
                                    ...
                                    <div class="row  mt-15">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label"> <?php echo e(__('front_settings.image')); ?> <span class="text-danger"> *</span></label>
                                                <div class="primary_file_uploader">
                                                    <input class="primary_input_field form-control<?php echo e($errors->has('image') ? ' is-invalid' : ''); ?>" id="placeholderInput" type="text"
                                                       placeholder="<?php echo e(isset($update) and $about_us ? ($about_us->image !="") ? getFilePath3($about_us->image) :trans('front_settings.image') .' *' :trans('front_settings.image') .' *'); ?>"
                                                       readonly>
                                    ...
                                    <div class="row  mt-15">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label"> <?php echo e(__('front_settings.main_image')); ?> <span class="text-danger"> *</span></label>
                                                <div class="primary_file_uploader">
                                                    <input class="primary_input_field form-control<?php echo e($errors->has('main_image') ? ' is-invalid' : ''); ?>" id="placeholderPhoto" type="text"
                                                       placeholder="<?php echo e(isset($update) and $about_us? ($about_us->main_image !="") ? getFilePath3($about_us->main_image) :trans('front_settings.main') .' '. trans('front_settings.image') .' *' :trans('front_settings.main') .' '. trans('front_settings.image') .' *'); ?>"
                                                       readonly>
                                                    <button class="" type="button">
                                                        <label class="primary-btn small fix-gr-bg" for="browseFile"><?php echo e(__('common.browse')); ?></label>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\backEnd\frontSettings\about_us.blade.php ENDPATH**/ ?>