    ...
    <div class="container-fluid p-0">
        <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="white-box">
                            <div class="row no-gutters input-right-icon mt-25">
                                <div class="col">
                                    <div class="primary_input">
                                        <input class="primary_input_field" type="text" id="placeholderInput" placeholder="Add Media"
                                            disabled>
                            ...
                            <div class="row mt-25">
                                <div class="col-lg-12">
                                    <img class="img-100" src="<?php echo e(asset('public/backEnd/img/front-cms/img1.jpg')); ?>" alt="">
                                    <img class="img-100" src="<?php echo e(asset('public/backEnd/img/front-cms/img2.jpg')); ?>" alt="">
                                    <img class="img-100" src="<?php echo e(asset('public/backEnd/img/front-cms/img3.jpg')); ?>" alt="">
                                </div>
            ...
            <div class="col-lg-9">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <table class="table school-table-data" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th>Title</th>
                                    <th>URL</th>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\frontEnd\front_cms_gallery.blade.php ENDPATH**/ ?>