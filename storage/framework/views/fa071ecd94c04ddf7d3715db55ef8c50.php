    ...
    <section class="news-area section-gap-top">
        <div class="container">
            ...
            <div class="row text-center mt-40">
                <div class="col-lg-12">
                    <a class="primary-btn fix-gr-bg semi-large load_more_btn" href="javascript::void(0)"><?php echo app('translator')->get('front_settings.load_more_news'); ?></a>
                </div>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('frontEnd.home.front_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\frontEnd\home\light_news.blade.php ENDPATH**/ ?>