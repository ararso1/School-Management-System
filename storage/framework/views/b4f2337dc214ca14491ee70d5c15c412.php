...
<div class="container-fluid">
    ...
    <form method="POST" class="" action="<?php echo e(route('fees-payment-stripe-store')); ?>" id="subscription-payment" data-cc-on-file="false" data-stripe-publishable-key="<?php echo e(@$stripe_info->gateway_publisher_key); ?>" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-lg-12">
                <input type="hidden" name="assign_id" value="<?php echo e($assign_id); ?>">
                <input type="hidden" name="student_id" value="<?php echo e($student_id); ?>">
                <input type="hidden" name="fees_type" value="<?php echo e($fees_type); ?>">
...
<?php /**PATH C:\xampp\htdocs\resources\views\backEnd\studentPanel\stripe_payment.blade.php ENDPATH**/ ?>