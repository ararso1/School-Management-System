    ...
    <div class="card-header">
        <h2 class="mb-0">
            <div class="btn hideArrow  d-flex align-items-center gap_10" type="button">
                <div class="flex-fill">
                    <h5>Online exam Level <?php echo e($level); ?> </h5>
        ...
        <div class="d-flex align-items-start flex-fill flex-column justify-content-center">
            <label class="primary_vcheckbox d-flex flex-fill">
                ...
                <span class="label_name">  <i
                            class="ti-control-play"></i> <span>Online exam Level <?php echo e($level); ?></span></span>
            </label>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\resources\views\lms\online_exam.blade.php ENDPATH**/ ?>