...
<?php endif; ?>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="studentTimeline">
                            <div class="white-box">
                                ...
                                <table id="" class="table simple-table table-responsive school-table"
                                    ...
                                    <?php $__currentLoopData = $student_detail->studentRecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="d-flex">
                                            <td class="col-4"><?php echo e($record->class->class_name); ?>
                        ...
                        <?php echo $__env->make('backEnd.parentPanel.inc._student_attendance_tab', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <!-- End Attendance Tab -->
                        <!-- Start Attendance Tab -->
                        <?php echo $__env->make('backEnd.parentPanel.inc._subject_attendance_tab', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <!-- End Attendance Tab -->
                        ...
                        <?php if(moduleStatusCheck('Wallet')): ?>
                            <div role="tabpanel" class="tab-pane fade" id="parentWallet">
                                <div class="white-box">
                                    <?php echo $__env->make(
                                        'wallet::_addWallet',
                                        compact('walletAmounts', 'bankAccounts', 'paymentMethods'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </div>
                            </div>
                        <?php endif; ?>
                    </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\backEnd\parentPanel\my_children.blade.php ENDPATH**/ ?>