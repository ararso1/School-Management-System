...
<?php echo app('translator')->get('front_settings.news_heading'); ?>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('mainContent'); ?>
    <section class="sms-breadcrumb mb-20">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1><?php echo app('translator')->get('front_settings.news_heading'); ?></h1>
                <div class="bc-pages">
                    <a href="<?php echo e(route('dashboard')); ?>"><?php echo app('translator')->get('common.dashboard'); ?></a>
                   <a href="#"> <?php echo app('translator')->get('front_settings.front_settings'); ?></a>
                   <a href="#"> <?php echo app('translator')->get('front_settings.news_heading'); ?></a>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <?php if(userPermission('news-heading-update')): ?>
                                <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'news-heading-update-new',
                            ...
                            <div class="white-box">
                                <div class="main-title">
                                    <h3 class="mb-15">
                                        <?php echo app('translator')->get('front_settings.update_news_heading_section'); ?>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="primary_input mt-15">
                                                <div class="primary_input">
                                                    ...
                                                    <textarea class="primary_input_field form-control" cols="0" rows="5" name="description" id="description"><?php echo e(isset($update)? ($SmNewsPage != ''? $SmNewsPage->description:''):''); ?></textarea>
                                            ...
                                            <div class="primary_input mt-15">
                                                <div class="primary_input">
                                                    ...
                                                    <textarea class="primary_input_field form-control" cols="0" rows="5" name="main_description" id="main_description"><?php echo e(isset($update)? ($SmNewsPage != ''? $SmNewsPage->main_description:''):''); ?></textarea>
                                        ...
                                        <div class="col-lg-12 mt-15">
                                            <div class="primary_input">
                                                <div class="primary_file_uploader">
                                                    ...
                                                    placeholder="<?php echo e(isset($update)? (($SmNewsPage and $SmNewsPage->image) !="") ? getFilePath3($SmNewsPage->image) :trans('common.image') .' *' :trans('common.image') .' *'); ?>"
                                                    readonly>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <div class="primary_file_uploader">
                                                    ...
                                                    placeholder="<?php echo e(isset($update)? ($SmNewsPage and $SmNewsPage->main_image !="") ? getFilePath3($SmNewsPage->main_image) :trans('common.main') .' '. trans('common.image') .' *' :trans('common.main') .' '. trans('common.image') .' *'); ?>"
                                                    readonly>
                                                    <button class="" type="button">
    ...
    <?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\backEnd\frontSettings\news\newsHeadingUpdate.blade.php ENDPATH**/ ?>