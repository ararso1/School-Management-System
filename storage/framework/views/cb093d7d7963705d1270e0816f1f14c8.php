                        ...
                        <div class="mt-10">
                            <?php if(isset($id_card)): ?>
                                ...
                                <?php if(($id_card->design_mode ?? 'classic') === 'template'): ?>
                                    <?php echo $__env->make('backEnd.admin.idCard.partials.template_preview', ['id_card' => $id_card], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php else: ?>
                            ...
                            <?php else: ?>
                                <?php $createMode = old('design_mode', 'template'); ?>
                                <div id="classicPreviewCreate" class="<?php echo e($createMode === 'template' ? 'd-none' : ''); ?>">
                                ...
                                <div id="templatePreviewCreate" class="<?php echo e($createMode === 'template' ? '' : 'd-none'); ?>">
                                    <?php
                                        $previewCard = (object) [
                                    ...
                                    ?>
                                    <?php echo $__env->make('backEnd.admin.idCard.partials.template_preview', ['id_card' => $previewCard], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\school-mgt\resources\views/backEnd/admin/idCard/student_id_card.blade.php ENDPATH**/ ?>