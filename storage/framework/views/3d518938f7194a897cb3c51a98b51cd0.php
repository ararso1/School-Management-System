<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('common.forum_topic_details'); ?>
<?php $__env->stopSection(); ?>

<?php $__env->startPush('css'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('/')); ?>/Modules/Forum/public/assets/css/style.css" />
    ...
    <section class="sms-breadcrumb mb-20">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1> <?php echo app('translator')->get('common.forum_topic_details'); ?></h1>
                <div class="bc-pages">
                    <a href="<?php echo e(route('dashboard')); ?>"><?php echo app('translator')->get('common.dashboard'); ?></a>
                    <a href="#"><?php echo app('translator')->get('common.forum'); ?></a>
                    <a href="#"><?php echo app('translator')->get('common.forum_topic_details'); ?></a>
                </div>
            </div>
        </div>
    </section>
                                    ...
                                    <div class="d-flex align-items-center gap-10">
                                        <div class="thumb" style="width: 45px">
                                            <img class="img-fluid rounded-circle"
                                                src="<?php echo e(asset('public/uploads/staff/demo/staff.jpg')); ?>"
                                                >
                                        </div>
                                        <div class="review_content">
                                            <h4 class="mb-0"><?php echo e(@$forum->createdBy->full_name); ?>

                                            </h4>
                                            <div class="rated_customer d-flex align-items-center">
                                                <span><?php echo e(dateconvert(@$forum->created_at)); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="course__details_title mb-4">
                                    <div class="single__details">
                                        <div class="details_content">
                                            ...
                                            <h4 class=""><?php echo e(@$forum->forumTitle->forumCategory->title); ?></h4>
                                        </div>
                                    </div>
                                    <div class="single__details">
                                        <div class="details_content">
                                            <span><?php echo app('translator')->get('common.forum_title'); ?></span>
                                            <h4 class=""><?php echo e(@$forum->forumTitle->title); ?></h4>
                                        </div>
                                    </div>
                                    <div class="single__details">
                                        <div class="details_content">
                                            <span><?php echo app('translator')->get('common.forum_topic'); ?></span>
                                            <h4 class=""><?php echo e(@$forum->title); ?></h4>
                                        </div>
                                    </div>
                                ...
                                <?php if($createdBy != $authUserId): ?>
                                    <div class="vote-section mt-4">
                                        <div class="d-flex justify-content-start align-items-center">
                                            <button class="btn btn-success btn-vote" id="upvote-button" onclick="handleVote('upvote', <?php echo e($forum->id); ?>)">
                                            ...
                                            </svg> <span id="upvote-count"><?php echo e($forum->upvotes); ?></span>
                                            </button>
                                            <button class="btn btn-danger btn-vote ml-2" id="downvote-button" onclick="handleVote('downvote', <?php echo e($forum->id); ?>)">
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    stroke="white" stroke-width="1.5" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                            </svg> <span id="downvote-count"><?php echo e($forum->downvotes); ?></span>
                                            </button>
                                        </div>
                                    </div>
                                <?php endif; ?>
                                ...
                                <div class="course_review_wrapper">
                                    <div class="course_cutomer_reviews">
                                        <div class="details_title">
                                            <h4 class="font_22 "><?php echo app('translator')->get('common.comments'); ?></h4>
                                        </div>
                                            ...
                                            <?php $__currentLoopData = $forum->forumComments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="single_reviews">
                                                    ...
                                                    <div class="review_content">
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <p class="my-4"><?php echo e($comment->comment); ?></p>
                                                                ...
                                                                <?php if($createdBy != $authUserId): ?>
                                                                    <div class="vote-section mt-2">
                                                                        <div class="d-flex justify-content-start align-items-center">
                                                                            <button class="btn btn-success btn-vote" id="comment-upvote-button" onclick="handleCommentVote('upvote', <?php echo e($comment->id); ?>)">
                                                                            <svg width="16" height="16"
                                                                                ...
                                                                                <path
                                                                                    ...
                                                                                    stroke-linecap="round"
                                                                                    stroke-linejoin="round" />
                                                                            </svg> <span id="comment-upvote-count"><?php echo e($comment->upvotes); ?></span>
                                                                            </button>
                                                                            <button class="btn btn-danger btn-vote ml-2" id="comment-downvote-button" onclick="handleCommentVote('downvote', <?php echo e($comment->id); ?>)">
                                                                            <svg width="16" height="16"
                                                                                viewBox="0 0 16 16" fill="none"
                                                                                xmlns="http://www.w3.org/2000/svg">
                                                                                <path
                                                                                ...
                                                                                <path
                                                                                    ...
                                                                                    stroke-linecap="round"
                                                                                    stroke-linejoin="round" />
                                                                            </svg> <span id="comment-downvote-count"><?php echo e($comment->downvotes); ?></span>
                                                                            </button>
                                                                        </div>
                                                                    </div>
                                                                <?php endif; ?>
                                                ...
                                                <div class="comment_replay_wized">
                                                    <div class="col-lg-12 collapse" id="mainComment<?php echo e($comment->id); ?>">
                                                        <form action="<?php echo e(route('user-forum-comment-reply.store')); ?>" method="post" class="">
                                                            <?php echo csrf_field(); ?>
                                                    ...
                                                    <?php $__currentLoopData = $comment->replies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reply): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="single_reviews">
                                                            <div class="d-flex align-items-center gap-10">
                                                                <div class="thumb">
                                                                    <?php if($reply->user): ?>
                                                                            ...
                                                                            <img class="img-fluid rounded-circle" src=" <?php echo e(@profile() && file_exists(@profile()) ? asset(profile()) : asset('public/backEnd/assets/img/avatar.png')); ?>" alt="">
                                                                    <?php endif; ?>
                                                            ...
                                                            <div class="review_content">
                                                                <p class="my-4"><?php echo e($reply->reply); ?></p>

                                                                <?php if($createdBy != $authUserId): ?>
                                                                    <div class="vote-section">
                                                                        <div class="d-flex justify-content-start align-items-center">
                                                                            <button class="btn btn-success btn-vote" id="reply-upvote-button" onclick="handleReplyVote('upvote', <?php echo e($reply->id); ?>)">
                                                                            <svg width="16" height="16"
                                                                                viewBox="0 0 16 16" fill="none"
                                                                                xmlns="http://www.w3.org/2000/svg">
                                                                                <path
                                                                                ...
                                                                                <path
                                                                                    ...
                                                                                    stroke-linecap="round"
                                                                                    stroke-linejoin="round" />
                                                                            </svg> <span id="reply-upvote-count"><?php echo e($reply->upvotes); ?></span>
                                                                            </button>
                                                                            <button class="btn btn-danger btn-vote ml-2" id="reply-downvote-button" onclick="handleReplyVote('downvote', <?php echo e($reply->id); ?>)">
                                                                            <svg width="16" height="16"
                                                                                viewBox="0 0 16 16" fill="none"
                                                                                xmlns="http://www.w3.org/2000/svg">
                                                                                <path
                                                                                ...
                                                                                <path
                                                                                    ...
                                                                                    stroke-linecap="round"
                                                                                    stroke-linejoin="round" />
                                                                            </svg> <span id="reply-downvote-count"><?php echo e($reply->downvotes); ?></span>
                                                                            </button>
                                                                        </div>
                                                                    </div>
                                                                <?php endif; ?>
                                                                ...
                                                                <div class="modal-dialog modal-lg" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'user-topic-comment-reply.update', 'method' => 'POST'])); ?>
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <div class="mt-40 d-flex justify-content-between">
                                                                                ...
                                                                                <a class="primary-btn fix-gr-bg" href="<?php echo e(route('user-forum-comment-reply.delete', [$reply->id])); ?>"
                                                ...
                                                <div class="modal fade" id="editCommentModal<?php echo e($comment->id); ?>" tabindex="-1" role="dialog" aria-labelledby="editModalCommentLabel<?php echo e($comment->id); ?>" aria-hidden="true">
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'user-topic-comment.update', 'method' => 'POST'])); ?>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mt-40 d-flex justify-content-between">
                                                                    <button type="button" class="primary-btn tr-bg"
                                                                        data-dismiss="modal"><?php echo app('translator')->get('common.cancel'); ?></button>
                                                                    <a class="primary-btn fix-gr-bg" href="<?php echo e(route('user-forum-comment.delete', [$comment->id])); ?>"
                                                                        class="text-light"> <?php echo app('translator')->get('common.delete'); ?>
                                                                    </a>
                                                                </div>
                                                            </div>
                                ...
                                <div class="conversition_box">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 " id="mainComment0">
                                            <form action="<?php echo e(route('user-forum-comment.store')); ?>" method="post" class="">
                                                <?php echo csrf_field(); ?>
                                                <input type="hidden" name="forum_topic_id" value="<?php echo e(@$forum->id); ?>">
                ...
                <div class="col-lg-3">
                    <div class="white-box">
                        <div class="fourm_cat_boxes mb_20 mt-20">
                            <h4 class="cat_title f_s_20  mb-2"><?php echo e(__('common.recent_discussion')); ?></h4>
                            <div class="discussion_lists">
                                <?php $__currentLoopData = $recent_forum; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r_forum): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="single_discussion py-2">
                                        <h5><a href="<?php echo e(route('user-forum.view',$r_forum->id)); ?>"><?php echo e(@$r_forum->title); ?></a></h5>
                                        <p><?php echo e(dateconvert(@$r_forum->created_at)); ?></p>
                                        <hr >
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
...
<?php $__env->startPush('script'); ?>
    <script>
        ...
        function handleVote(type, forumId) {
            ...
            $.ajax({
                url: '<?php echo e(route('user-forum-vote.store')); ?>',
                type: 'POST',
                data: {
        ...
        function handleCommentVote(type, commentId) {
            ...
            $.ajax({
                url: '<?php echo e(route('user-forum-comment-vote.store')); ?>',
                type: 'POST',
                data: {
                    _token: '<?php echo e(csrf_token()); ?>',
                    commentId: commentId,
        ...
        function handleReplyVote(type, replyId) {
            ...
            $.ajax({
                url: '<?php echo e(route('user-forum-reply-vote.store')); ?>',
                type: 'POST',
                data: {
                    _token: '<?php echo e(csrf_token()); ?>',
                    replyId: replyId,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\backEnd\userForum\topic_view.blade.php ENDPATH**/ ?>