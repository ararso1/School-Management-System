<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('hr.donor_registration'); ?>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('mainContent'); ?>
    <section class="sms-breadcrumb mb-20 up_breadcrumb">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1><?php echo app('translator')->get('hr.donor_registration'); ?></h1>
                <div class="bc-pages">
                    <a href="<?php echo e(route('dashboard')); ?>"><?php echo app('translator')->get('common.dashboard'); ?></a>
                    <a href="#"><?php echo app('translator')->get('student.custom_field'); ?></a>
                    <a href="#"><?php echo app('translator')->get('hr.donor_registration'); ?></a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container-fluid p-0">
            <?php if(isset($v_custom_field)): ?>
                <div class="row">
                    <div class="offset-lg-10 col-lg-2 text-right col-md-12 mb-20">
                        <a href="<?php echo e(route('donor-reg-custom-field')); ?>" class="primary-btn small fix-gr-bg">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        <?php if(isset($v_custom_field)): ?>
                            <?php echo e(Form::open(['class' => 'form-horizontal', 'route' => 'update-donor-custom-field', 'method' => 'POST'])); ?>

                            <input type="hidden" name="id" value="<?php echo e($v_custom_field->id); ?>">
                        <?php else: ?>
                            <?php echo e(Form::open(['class' => 'form-horizontal', 'route' => 'store-donor-registration-custom-field', 'method' => 'POST'])); ?>
                    ...
                    <div class="row">
                        <div class="col-lg-4 no-gutters">
                            <div class="main-title">
                                <h3 class="mb-0"><?php echo app('translator')->get('student.custom_field_list'); ?></h3>
                            </div>
                        </div>
                    </div>
                    <div class="row  ">
                                                ...
                                                <td>
                                                    <div class="dropdown CRM_dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <?php if(userPermission('edit-donor-custom-field')): ?>
                                                                <a class="dropdown-item"
                                                                    href="<?php echo e(route('edit-donor-custom-field', ['id' => @$custom_field->id])); ?>"><?php echo app('translator')->get('common.edit'); ?></a>
                                                            <?php endif; ?>
                                                            <?php if(userPermission('delete-donor-custom-field')): ?>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mt-40 d-flex justify-content-between">
                                                                ...
                                                                <?php echo e(Form::open(['route' => 'delete-donor-custom-field', 'method' => 'POST'])); ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\backEnd\customField\donorRegistration.blade.php ENDPATH**/ ?>