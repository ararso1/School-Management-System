                    ...
                    <a href="#" class="d-block">
                        <div class="white-box single-summery">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h3><?php echo app('translator')->get('front_settings.Opened_in'); ?></h3>
                ...
                <div class="col-lg-4 mt-20-lg">
                    <a href="#" class="d-block">
                        <div class="white-box single-summery">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h3><?php echo app('translator')->get('dashboard.students'); ?></h3>
                                    <p class="mb-0"><?php echo app('translator')->get('dashboard.total_students'); ?></p>
                                </div>
                                <h1 class="gradient-color2">
                                    <?php if(isset($totalStudents)): ?>
                ...
                <div class="col-lg-4 mt-20-lg">
                    <a href="#" class="d-block">
                        <div class="white-box single-summery">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h3><?php echo app('translator')->get('front_settings.faculty'); ?></h3>
                                    <p class="mb-0"><?php echo app('translator')->get('front_settings.Total_Teachers_count'); ?></p>
                                </div>
                                <h1 class="gradient-color2">
...
<?php echo $__env->make('frontEnd.home.front_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\frontEnd\home\light_about.blade.php ENDPATH**/ ?>