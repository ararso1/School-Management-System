            ...
            <div class="col-lg-6 col-xl-5">
                <div class="banner_text">
                    <div class="banner_text_iner">
                        ...
                        <?php endif; ?>
                        <a href="<?php echo e(url('/home')); ?>" class="btn_2" target="_blank"> <i class="ti-package"></i> Try Live Demo</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                        <img src="<?php echo e(asset('public/landing/img/logo.png')); ?>" alt="logo"> </a>
                    ...
                    <div class="collapse navbar-collapse main-menu-item justify-content-center"
                        ...
                        <ul class="navbar-nav align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(url('/home')); ?>" target="_blank" >Frontend</a>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="copyright_text">
                    <p> <img src="<?php echo e(asset('public/landing/img/copyright.svg')); ?>" alt="#"> 2019-2020 InfixEdu - Ultimate Education ERP. All Rights
...
<?php /**PATH C:\xampp\htdocs\resources\views\frontEnd\landing\index.blade.php ENDPATH**/ ?>