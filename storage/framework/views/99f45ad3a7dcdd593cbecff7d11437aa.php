    ...
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col-lg-4 no-gutters">
                <div class="main-title">
                    <h3 class="mb-30">ID Card Report</h3>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="white-box">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="student-admit-card">
                                <div class="admit-header">

                                </div>
                                <img class="admit-meta-img img-100" src="<?php echo e(asset('public/backEnd/img/student/student-meta-img.png')); ?>" alt="">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\frontEnd\admit_card_report.blade.php ENDPATH**/ ?>