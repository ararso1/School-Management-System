...
<nav id="sidebar" class="sidebar">
    ...
    <?php if(auth()->user()->is_saas == 0): ?>
        ...
        <ul class="sidebar_menu list-unstyled" id="sidebar_menu">
            ...
            <?php if(isSubscriptionEnabled() && auth()->user()->is_administrator != 'yes'): ?>
            ...
            <?php else: ?>
                <?php if(isMenuAllowToShow('menu_manage')): ?>
                ...
                <?php if(auth()->user()->role_id != 2 && auth()->user()->role_id != 3): ?>
                    ...
                    <?php endif; ?>
                    <?php if(userPermission('admin_section') && menuStatus(11) && isMenuAllowToShow('admin_section')): ?>
                        <li data-position="<?php echo e(menuPosition(11)); ?>" class="sortable_li">
                            <a href="javascript:void(0)" class="has-arrow" aria-expanded="false">
                                ...
                                <div class="nav_title">
                                    <span><?php echo app('translator')->get('admin.admin_section'); ?></span>

                                </div>
                            </a>
                            <ul class="list-unstyled">
                                <?php if(userPermission('admission_query') && menuStatus(12)): ?>
                                ...
                                <?php if(userPermission('visitor') && menuStatus(16)): ?>
                                ...
                                <?php if(userPermission('complaint') && menuStatus(21)): ?>
                                ...
                                <?php endif; ?>
                                <?php if(userPermission('postal-receive') && menuStatus(27)): ?>
                                ...
                                <?php endif; ?>
                                <?php if(userPermission('postal-dispatch') && menuStatus(32)): ?>
                                ...
                                <?php endif; ?>
                                <?php if(userPermission('phone-call') && menuStatus(36)): ?>
                                ...
                                <?php endif; ?>
                                <?php if(userPermission('setup-admin') && menuStatus(41)): ?>
                                ...
                                <?php endif; ?>
                                <?php if(userPermission('student-certificate') && menuStatus(49)): ?>
                                ...
                                <?php endif; ?>
                                <?php if(userPermission('generate_certificate') && menuStatus(53)): ?>
                                ...
                                <?php endif; ?>
                                <?php if(userPermission('student-id-card') && menuStatus(45)): ?>
                                ...
                                <?php endif; ?>
                                <?php if(userPermission('generate_id_card') && menuStatus(57)): ?>
                    ...
                    <?php if(userPermission('student_info') && menuStatus(61) && isMenuAllowToShow('student_info')): ?>
                        <li data-position="<?php echo e(menuPosition(61)); ?>" class="sortable_li">
                            <a href="javascript:void(0)" class="has-arrow" aria-expanded="false">
                                ...
                                <div class="nav_title">
                                    <span> <?php echo app('translator')->get('student.student_information'); ?></span>
                                </div>
                            </a>
                            <ul class="list-unstyled" id="subMenuStudent">
                                <?php if(userPermission('student_category') && menuStatus(71)): ?>
                                ...
                                <?php endif; ?>
                                <?php if(userPermission('student_admission') && menuStatus(62)): ?>
                                ...
                                <?php endif; ?>
                                <?php if(userPermission('student_list') && menuStatus(64)): ?>
                                ...
                                <?php endif; ?>
                                <?php if(userPermission('student.multi-class-student') && menuStatus(64)): ?>
                                    <li data-position="<?php echo e(menuPosition(64)); ?>">
                                        <a href="<?php echo e(route('student.multi-class-student')); ?>"> <?php echo app('translator')->get('student.multi_class_student'); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if(userPermission('student.delete-student-record') && menuStatus(64)): ?>
                                    <li data-position="<?php echo e(menuPosition(64)); ?>">
                                        <a href="<?php echo e(route('student.delete-student-record')); ?>"> <?php echo app('translator')->get('student.delete_student_record'); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if(userPermission('student_attendance') && menuStatus(68)): ?>
                                ...
                                <?php endif; ?>
                                <?php if(userPermission('student_attendance_report') && menuStatus(70)): ?>
                                ...
                                <?php endif; ?>
                                <?php if(userPermission('subject-wise-attendance') && menuStatus(533)): ?>
                                ...
                                <?php if(userPermission(81) && menuStatus(81)): ?>
                                    <li data-position="<?php echo e(menuPosition(81)); ?>">
                                        <?php if(moduleStatusCheck('University')): ?>
                                            <a href="<?php echo e(route('university.student_promote')); ?>"><?php echo app('translator')->get('student.student_promote'); ?></a>
                                        <?php else: ?>
                    ...
                    <?php if(userPermission(245) && menuStatus(245) && isMenuAllowToShow('academics')): ?>
                        <li data-position="<?php echo e(menuPosition(245)); ?>" class="sortable_li">
                            ...
                            <ul class="mm-collapse" id="subMenuAcademic">
                                <?php if(userPermission(537) && menuStatus(537)): ?>
                                    <li data-position="<?php echo e(menuPosition(537)); ?>">
                                        <a href="<?php echo e(route('global_section')); ?>"> <?php echo app('translator')->get('academics.global_section'); ?>
                                        </a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php if(userPermission(537) && menuStatus(537)): ?>
                                    <li data-position="<?php echo e(menuPosition(537)); ?>">
                                        <a href="<?php echo e(route('global_class')); ?>"> <?php echo app('translator')->get('academics.global_class'); ?>
                                        </a>
                                    </li>
                                <?php endif; ?>
                                <?php if(userPermission(537) && menuStatus(537)): ?>
                                    <li data-position="<?php echo e(menuPosition(537)); ?>">
                                        <a href="<?php echo e(route('global_subject')); ?>"> <?php echo app('translator')->get('academics.global_subject'); ?>
                                        </a>
                                    </li>
                                <?php endif; ?>
                                <?php if(userPermission(537) && menuStatus(537)): ?>
                                    <li data-position="<?php echo e(menuPosition(537)); ?>">
                                        <a href="<?php echo e(route('global_assign_subject')); ?>"> <?php echo app('translator')->get('academics.assign_subject'); ?>
                                        </a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php if(userPermission(537) && menuStatus(537)): ?>
                                    <li data-position="<?php echo e(menuPosition(537)); ?>">
                                        <a href="<?php echo e(route('global-upload-content')); ?>"> <?php echo app('translator')->get('academics.global_study_material'); ?>
                                        </a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php if(userPermission(208) && menuStatus(208)): ?>
                                    <li data-position="<?php echo e(menuPosition(208)); ?>">
                                        <a href="<?php echo e(route('global_exam-type')); ?>"> <?php echo app('translator')->get('exam.global_exam_type'); ?></a>
                                    </li>
                                <?php endif; ?>

                                <?php if(userPermission(208) && menuStatus(208)): ?>
                                    <li data-position="<?php echo e(menuPosition(208)); ?>">
                                        <a href="<?php echo e(route('global-exam')); ?>"> <?php echo app('translator')->get('exam.global_exam'); ?></a>
                                    </li>
                                <?php endif; ?>

                                <?php if(userPermission(208) && menuStatus(208)): ?>
                                    <li data-position="<?php echo e(menuPosition(208)); ?>">
                                        <a href="<?php echo e(route('global-assign')); ?>"> <?php echo app('translator')->get('academics.global_exam_setup'); ?></a>
                                    </li>
                                <?php endif; ?>
                    ...
                    <?php if(userPermission(245) && menuStatus(245) && isMenuAllowToShow('academics')): ?>
                        <li data-position="<?php echo e(menuPosition(245)); ?>" class="sortable_li">
                            <a href="javascript:void(0)" class="has-arrow" aria-expanded="false">
                                ...
                                <div class="nav_title">
                                    <span> <?php echo app('translator')->get('academics.academics'); ?></span>
                            ...
                            <ul class="list-unstyled" id="subMenuAcademic">
                                ...
                                <?php else: ?>
                                    ...
                                    <?php if(moduleStatusCheck('University')): ?>
                                        <?php if(userPermission(246) && menuStatus(246)): ?>
                                            <li data-position="<?php echo e(menuPosition(246)); ?>">
                                                <a href="<?php echo e(route('university.academics.classRoutine')); ?>">
                                                    <?php echo app('translator')->get('academics.class_routine'); ?></a>
                                            </li>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                ...
                                <?php if(auth()->user()->role_id == 4): ?>
                                    <li>
                                        <a href="<?php echo e(route('view-teacher-routine')); ?>"><?php echo app('translator')->get('academics.view_class_routine'); ?></a>
                                    </li>
                                <?php endif; ?>
                    ...
                    <?php if(userPermission('study_material') && menuStatus(87) && isMenuAllowToShow('study_material')): ?>
                        <li data-position="<?php echo e(menuPosition(87)); ?>" class="sortable_li">
                            <a href="javascript:void(0)" class="has-arrow" aria-expanded="false">
                                ...
                                <div class="nav_title">
                                    <span><?php echo app('translator')->get('study.study_material'); ?></span>

                                </div>
                            </a>
                            <ul class="list-unstyled" id="subMenuTeacher">
                                <?php if(userPermission('upload-content') && menuStatus(87)): ?>
                                ...
                                <?php endif; ?>
                                <?php if(userPermission('assignment-list') && menuStatus(92)): ?>
                    ...
                    <?php if(userPermission(800) && menuStatus(800) && isMenuAllowToShow('lesson_plan')): ?>
                        <li data-position="<?php echo e(menuPosition(800)); ?>" class="sortable_li">
                            <a href="javascript:void(0)" class="has-arrow" aria-expanded="false">
                                ...
                                <div class="nav_title">
                                    <span><?php echo app('translator')->get('lesson::lesson.lesson_plan'); ?></span>
                            ...
                            <?php if(userPermission(108) && menuStatus(108)): ?>
                                <li data-position="<?php echo e(menuPosition(108)); ?>" class="sortable_li">
                                    <a href="javascript:void(0)" class="has-arrow" aria-expanded="false">
                                        ...
                                        <div class="nav_title">
                                            <span><?php echo app('translator')->get('fees.fees_collection'); ?></span>
                                    ...
                                    <ul class="list-unstyled" id="subMenuFeesCollection">
                                        ...
                                        <?php endif; ?>
                                        <?php if(userPermission(116) && menuStatus(116) && !directFees()): ?>
                                        ...
                                        <?php if(userPermission(383) && menuStatus(383)): ?>
                                            <li data-position="<?php echo e(menuPosition(383)); ?>">
                                                <a href="<?php echo e(route('transaction_report')); ?>"><?php echo app('translator')->get('fees.collection_report'); ?></a>
                                            </li>
                                        <?php endif; ?>
                    ...
                    <?php if(moduleStatusCheck('University')): ?>
                        <?php echo $__env->make('university::un_menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php endif; ?>


                    <?php if(moduleStatusCheck('Alumni')): ?>
                        <?php echo $__env->make('alumni::alumni_menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php endif; ?>


                    <?php if(isMenuAllowToShow('wallet')): ?>
                    ...
                    <?php if(moduleStatusCheck('BulkPrint') == true && isMenuAllowToShow('bulk_print')): ?>
                    ...
                    <?php if(userPermission(137) && menuStatus(137) && isMenuAllowToShow('accounts')): ?>
                        <li data-position="<?php echo e(menuPosition(137)); ?>" class="sortable_li">
                            <a href="javascript:void(0)" class="has-arrow" aria-expanded="false">
                                ...
                                <div class="nav_title">
                                    <span><?php echo app('translator')->get('accounts.accounts'); ?></span>
                    ...
                    <?php if(userPermission(160) && menuStatus(160) && isMenuAllowToShow('human_resource')): ?>
                        <li data-position="<?php echo e(menuPosition(160)); ?>" class="sortable_li">
                            <a href="javascript:void(0)" class="has-arrow" aria-expanded="false">
                                ...
                                <div class="nav_title">
                                    <span><?php echo app('translator')->get('hr.human_resource'); ?></span>
                    ...
                    <?php if(userPermission(188) && menuStatus(188) && isMenuAllowToShow('leave')): ?>
                            ...
                            <ul class="list-unstyled" id="subMenuLeaveManagement">
                                ...
                                <?php if(userPermission(189) && menuStatus(189)): ?>
                                    <li data-position="<?php echo e(menuPosition(189)); ?>">
                                        <a href="<?php echo e(route('approve-leave')); ?>"><?php echo app('translator')->get('leave.approve_leave_request'); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if(userPermission(196) && menuStatus(196)): ?>
                                    <li data-position="<?php echo e(menuPosition(196)); ?>">
                                        <a href="<?php echo e(route('pending-leave')); ?>"><?php echo app('translator')->get('leave.pending_leave_request'); ?></a>
                                    </li>
                                <?php endif; ?>
                    ...
                    <?php if(userPermission(1100) && menuStatus(1100) && isMenuAllowToShow('custom_field')): ?>
                        <li data-position="<?php echo e(menuPosition(1100)); ?>" class="sortable_li">
                            <a href="javascript:void(0)" class="has-arrow" aria-expanded="false">
                                ...
                                <div class="nav_title">
                                    <span><?php echo app('translator')->get('student.custom_field'); ?></span>
                    ...
                    <?php if(userPermission(207) && menuStatus(207) && isMenuAllowToShow('examination')): ?>
                        <li data-position="<?php echo e(menuPosition(207)); ?>" class="sortable_li">
                            ...
                            <ul class="list-unstyled" id="subMenuExam">
                                ...
                                <?php if(@generalSetting()->result_type == 'mark'): ?>
                                    <?php if(userPermission(3214) && menuStatus(3214)): ?>
                                        <li data-position="<?php echo e(menuPosition(3214)); ?>">
                                            <a href="<?php echo e(route('custom-marksheet-report')); ?>">
                                                <?php echo app('translator')->get('exam.marksheet_report'); ?>
                                            </a>
                                        </li>
                                    <?php endif; ?>

                                    <?php if(userPermission(3215) && menuStatus(3215)): ?>
                                        <li data-position="<?php echo e(menuPosition(3215)); ?>">
                                            <a href="<?php echo e(route('subjectMarkSheet')); ?>"><?php echo app('translator')->get('exam.subject_mark_sheet'); ?></a>
                                        </li>
                                    <?php endif; ?>

                                    <?php if(userPermission(3216) && menuStatus(3216)): ?>
                                        <li data-position="<?php echo e(menuPosition(3216)); ?>">
                                            <a href="<?php echo e(route('finalMarkSheet')); ?>"><?php echo app('translator')->get('exam.final_mark_sheet'); ?></a>
                                        </li>
                                    <?php endif; ?>

                                    <?php if(userPermission(3217) && menuStatus(3217)): ?>
                                        <li data-position="<?php echo e(menuPosition(3217)); ?>">
                                            <a href="<?php echo e(route('studentFinalMarkSheet')); ?>"><?php echo app('translator')->get('exam.student_final_mark_sheet'); ?></a>
                                        </li>
                                    <?php endif; ?>
                                        ...
                                        <ul class="list-unstyled <?php echo e(spn_nav_item_open($subMenuExam, 'show')); ?>"
                                            ...
                                            <?php if(userPermission(706) && menuStatus(706)): ?>
                                                <li data-position="<?php echo e(menuPosition(706)); ?>">
                                                    <a href="<?php echo e(route('exam-settings')); ?>"><?php echo app('translator')->get('exam.format_settings'); ?></a>
                                                </li>
                                            <?php endif; ?>

                                            <li>
                                                <a href="<?php echo e(route('exam-report-position')); ?>"><?php echo app('translator')->get('exam.position'); ?></a>
                                            </li>
                                        </ul>
                                    </li>
                                <?php endif; ?>
                    ...
                    <?php else: ?>
                        <?php if(userPermission(875) && menuStatus(875) && isMenuAllowToShow('online_exam')): ?>
                            <li data-position="<?php echo e(menuPosition(875)); ?>" class="sortable_li">
                                <a href="javascript:void(0)" class="has-arrow" aria-expanded="false">
                                    ...
                                    <div class="nav_title">
                                        <span> <?php echo app('translator')->get('exam.online_exam'); ?></span>
                    ...
                    <?php if(userPermission(277) && menuStatus(277) && isMenuAllowToShow('home_work')): ?>
                    ...
                    <?php if(userPermission(286) && menuStatus(286) && isMenuAllowToShow('communicate')): ?>
                        <li data-position="<?php echo e(menuPosition(286)); ?>" class="sortable_li">
                            <a href="javascript:void(0)" class="has-arrow" aria-expanded="false">
                                ...
                                <div class="nav_title">
                                    <span><?php echo app('translator')->get('communicate.communicate'); ?></span>
                    ...
                    <?php if(userPermission(298) && menuStatus(298) && isMenuAllowToShow('library')): ?>
                    ...
                    <?php if(userPermission(315) && menuStatus(315) && isMenuAllowToShow('inventory')): ?>
                        <li data-position="<?php echo e(menuPosition(315)); ?>" class="sortable_li">
                            <a href="javascript:void(0)" class="has-arrow" aria-expanded="false">
                                ...
                                <div class="nav_title">
                                    <span><?php echo app('translator')->get('inventory.inventory'); ?></span>
                    ...
                    <?php if(userPermission(348) && menuStatus(348) && isMenuAllowToShow('transport')): ?>
                    ...
                    <?php if(userPermission(362) && menuStatus(362) && isMenuAllowToShow('dormitory')): ?>
                    ...
                    <?php if(userPermission(376) && menuStatus(376) && isMenuAllowToShow('reports')): ?>
                        <li data-position="<?php echo e(menuPosition(376)); ?>" class="sortable_li">
                            <a href="javascript:void(0)" class="has-arrow" aria-expanded="false">
                                ...
                                <div class="nav_title">
                                    <span><?php echo app('translator')->get('reports.reports'); ?></span>
                            ...
                            <ul class="list-unstyled" id="subMenusystemReports">
                                ...
                                <?php if(userPermission(385) && menuStatus(385)): ?>
                                    <li data-position="<?php echo e(menuPosition(385)); ?>">
                                        <a href="<?php echo e(route('class_routine_report')); ?>"><?php echo app('translator')->get('reports.class_routine'); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if(!moduleStatusCheck('University')): ?>
                                ...
                                <?php if(userPermission(388) && menuStatus(388)): ?>
                                    <li data-position="<?php echo e(menuPosition(388)); ?>">
                                        <a href="<?php echo e(route('merit_list_report')); ?>"><?php echo app('translator')->get('reports.merit_list_report'); ?></a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php if(!moduleStatusCheck('University')): ?>
                                    <?php if(userPermission(389) && menuStatus(389)): ?>
                                        <li data-position="<?php echo e(menuPosition(389)); ?>">
                                            <a href="<?php echo e(route('online_exam_report')); ?>"><?php echo app('translator')->get('reports.online_exam_report'); ?></a>
                                        </li>
                                    <?php endif; ?>
                                <?php endif; ?>
                                <?php if(userPermission(390) && menuStatus(390)): ?>
                                    <li data-position="<?php echo e(menuPosition(390)); ?>">
                                        <a href="<?php echo e(route('mark_sheet_report_student')); ?>"><?php echo app('translator')->get('reports.mark_sheet_report'); ?></a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php if(!moduleStatusCheck('University')): ?>
                                    ...
                                    <?php if(userPermission(392) && menuStatus(392)): ?>
                                        <li data-position="<?php echo e(menuPosition(392)); ?>">
                                            <a href="<?php echo e(route('progress_card_report')); ?>"><?php echo app('translator')->get('reports.progress_card_report'); ?></a>
                                        </li>
                                    <?php endif; ?>
                                <?php endif; ?>
                                ...
                                <?php if(moduleStatusCheck('University')): ?>
                                    <li data-position="">
                                        <a href="<?php echo e(route('university.exam-report')); ?>">
                                            <?php echo app('translator')->get('university::un.exam_report'); ?>
                                        </a>
                                    </li>
                                <?php endif; ?>
                    ...
                    <?php if(userPermission(417) && menuStatus(417) && isMenuAllowToShow('role_permission')): ?>
                        <li data-position="<?php echo e(menuPosition(417)); ?>" class="sortable_li">
                            <a href="javascript:void(0)" class="has-arrow" aria-expanded="false">
                                ...
                                <div class="nav_title">
                                    <span><?php echo app('translator')->get('rolepermission::role.role_&_permission'); ?></span>
                            ...
                            <ul class="list-unstyled" id="subMenuUserManagement">
                                <?php if(userPermission(585) && menuStatus(585)): ?>
                                    <li data-position="<?php echo e(menuPosition(585)); ?>">
                                        <a href="<?php echo e(route('rolepermission/role')); ?>"><?php echo app('translator')->get('rolepermission::role.role'); ?></a>
                                    </li>
                                <?php endif; ?>
                    ...
                    <?php if(userPermission(398) && menuStatus(398) && isMenuAllowToShow('system_settings')): ?>
                        <li data-position="<?php echo e(menuPosition(398)); ?>" class="sortable_li metis_submenu_up_collaspe">
                            <a href="javascript:void(0)" class="has-arrow" aria-expanded="false">
                                ...
                                <div class="nav_title">
                                    <span><?php echo app('translator')->get('system_settings.system_settings'); ?></span>
                            ...
                            <ul class="list-unstyled" id="subMenusystemSettings">
                                ...
                                <?php if(userPermission(401) && menuStatus(401)): ?>
                                    <li data-position="<?php echo e(menuPosition(401)); ?>">
                                        <a href="<?php echo e(route('manage-currency')); ?>"><?php echo app('translator')->get('system_settings.manage_currency'); ?></a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php if(userPermission(451) && menuStatus(451)): ?>
                                    <li data-position="<?php echo e(menuPosition(451)); ?>">
                                        <a href="<?php echo e(route('language-settings')); ?>"><?php echo app('translator')->get('system_settings.language_settings'); ?></a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php if(moduleStatusCheck('Saas') and config('app.allow_custom_domain')): ?>
                                    <li>
                                        <a href="<?php echo e(route('saas.custom-domain')); ?>"><?php echo app('translator')->get('saas::saas.custom_domain'); ?></a>
                                    </li>
                                <?php endif; ?>
                    ...
                    <?php if(userPermission(485) && menuStatus(485) && isMenuAllowToShow('style')): ?>
                        <li data-position="<?php echo e(menuPosition(485)); ?>" class="sortable_li metis_submenu_up_collaspe">
                            <a href="javascript:void(0)" class="has-arrow" aria-expanded="false">
                                ...
                                <div class="nav_title">
                                    <span><?php echo app('translator')->get('style.style'); ?></span>
                    ...
                    <?php if(userPermission(492) && menuStatus(492) && isMenuAllowToShow('front_setting')): ?>
                        <li data-position="<?php echo e(menuPosition(492)); ?>" class="sortable_li metis_submenu_up_collaspe">
                            <a href="javascript:void(0)" class="has-arrow" aria-expanded="false">
                                ...
                                <div class="nav_title">
                                    <span><?php echo app('translator')->get('front_settings.front_settings'); ?></span>
                            ...
                            <ul class="list-unstyled" id="subMenufrontEndSettings">
                                <?php if(userPermission(650) && menuStatus(650)): ?>
                                    <li data-position="<?php echo e(menuPosition(650)); ?>">
                                        <a href="<?php echo e(route('header-menu-manager')); ?>"><?php echo app('translator')->get('front_settings.header_menu_manager'); ?></a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php if(userPermission(523) && menuStatus(523)): ?>
                                    <li data-position="<?php echo e(menuPosition(528)); ?>">
                                        <a href="<?php echo e(route('news-heading-update')); ?>"><?php echo app('translator')->get('front_settings.news_heading'); ?></a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php if(moduleStatusCheck('AppSlider') == true): ?>
                                    <?php if(userPermission(930) && menuStatus(930)): ?>
                                        <li data-position="<?php echo e(menuPosition(930)); ?>">
                                            <a href="<?php echo e(route('appslider.index')); ?>"><?php echo app('translator')->get('front_settings.app_slider'); ?></a>
                                        </li>
                                    <?php endif; ?>
                                <?php endif; ?>
                                ...
                                <?php if(userPermission(525) && menuStatus(525)): ?>
                                    <li data-position="<?php echo e(menuPosition(525)); ?>">
                                        <a href="<?php echo e(route('course-heading-update')); ?>"><?php echo app('translator')->get('front_settings.course_heading'); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if(userPermission(525) && menuStatus(525)): ?>
                                    <li data-position="<?php echo e(menuPosition(525)); ?>">
                                        <a href="<?php echo e(route('course-details-heading')); ?>"><?php echo app('translator')->get('front_settings.course_details_heading'); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if(userPermission(673) && menuStatus(673)): ?>
                                    <li data-position="<?php echo e(menuPosition(673)); ?>">
                                        <a href="<?php echo e(route('course-category')); ?>"><?php echo app('translator')->get('front_settings.course_category'); ?></a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php if(userPermission(504) && menuStatus(504)): ?>
                                    <li data-position="<?php echo e(menuPosition(504)); ?>">
                                        <a href="<?php echo e(route('testimonial_index')); ?>"><?php echo app('translator')->get('front_settings.testimonial'); ?></a>
                                    </li>
                                <?php endif; ?>
                    ...
                    <?php if(moduleStatusCheck('Saas') == true && auth()->user()->is_administrator != 'yes'): ?>
                        <li>
                            <a href="javascript:void(0)" class="has-arrow" aria-expanded="false">
                                ...
                                <div class="nav_title">
                                    <span><?php echo app('translator')->get('saas::saas.ticket_system'); ?></span>
...
<!-- sidebar part end -->
<?php /**PATH C:\xampp\htdocs\resources\views\backEnd\partials\sidebar_copy.blade.php ENDPATH**/ ?>