        ...
        <div class="card">
            ...
            <div class="card-body">
                <?php if(Session::has('message-success')): ?>
                    <p class="alert alert-success"><?php echo e(Session::get('message-success')); ?></p>
                <?php endif; ?>
                <form method="post" action="<?php echo e(route('installStep2')); ?>">
...
<?php /**PATH C:\xampp\htdocs\resources\views\install\installPage2.blade.php ENDPATH**/ ?>