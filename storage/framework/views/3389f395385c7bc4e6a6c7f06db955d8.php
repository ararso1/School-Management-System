...
<div class="student-details">
    <div class="row">
        <div class="<?php echo e(isset($apply)? 'col-md-12':'col-md-7'); ?>">
                ...
                <div class="single-meta">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-7">
                            <div class="name">
                                <?php echo e(@$leaveDetails->leaveType->type); ?>

                            </div>
                        </div>
                        <div class="col-lg-2 col-md-5">
                            <div class="value text-left">
                                <?php echo app('translator')->get('leave.duration'); ?>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-7">
                            <div class="name">
            ...
            <div class="single-meta">
                <div class="row">
                    <div class="col-lg-2 col-md-2">
                        <div class="value text-left">
                            <?php echo app('translator')->get('leave.attach_file'); ?>
                        </div>
                    </div>
            ...
            <div class="single-meta mt-40">
                <div class="row">
                    <div class="col-lg-2 col-md-5">
                        ...
                        <?php if(Auth::user()->role_id==1 || Auth::user()->role_id==4 || userPermission('approve-leave-edit','approve-leave-delete')): ?>
                                <div class="col-lg-4 col-md-7">
        ...
        <div class="col-md-5    ">
                ...
                <div class="student-meta-box">
                        <?php if($leaveDetails->role_id == 2): ?>
                           <h5 class="mt-20 mb-20"><?php echo app('translator')->get('leave.user_details'); ?></h5>
                        <?php else: ?>
                    ...
                    <div class="white-box-modal radius-t-y-0">
                        ...
                        <div class="single-meta mt-50">
                            <div class="d-flex justify-content-between">
                                <div class="name">
                                    <?php if($leaveDetails->role_id == 2): ?>
                                     <?php echo app('translator')->get('leave.user_name'); ?>
                                    <?php else: ?>
                        ...
                        <div class="single-meta">
                            <div class="d-flex justify-content-between">
                                <div class="name">
                                    <?php if($leaveDetails->role_id == 2): ?>
                                     <?php echo app('translator')->get('leave.user_no'); ?>
                                    <?php else: ?>
                    ...
                    <h5 class="mt-20 mb-20"><?php echo app('translator')->get('leave.leave_details'); ?></h5>
                            <table class="table school-table-style-modal p-3" cellspacing="0" width="100%">
                            <thead>
                                <tr>
...
<?php /**PATH C:\xampp\htdocs\resources\views\backEnd\humanResource\viewLeaveDetails.blade.php ENDPATH**/ ?>