...
<?php $__env->startSection('mainContent'); ?>
    <div class="role_permission_wrap">
        <div class="permission_title d-flex flex-wrap justify-content-between mb_10">
            ...
            <div class="">
                ...
                <a href="<?php echo e(route('menumanage.reset-with-section', ['role_id' => @$role->id])); ?>"
    ...
    <input type="hidden" id="order_change_url" value="<?php echo e(route('sidebar-manager.menu-update', ['role_id' => $role->id])); ?>">

    <input type="hidden" id="section_store_url" value="<?php echo e(route('sidebar-manager.section.store', ['role_id' => $role->id])); ?>">
    <input type="hidden" id="section_delete_url" value="<?php echo e(route('sidebar-manager.delete-section', ['role_id' => $role->id])); ?>">
    <input type="hidden" id="menu_delete_url" value="<?php echo e(route('sidebar-manager.menu-store', ['role_id' => $role->id])); ?>">
    <input type="hidden" id="menu_remove_url" value="<?php echo e(route('sidebar-manager.menu-remove', ['role_id' => $role->id])); ?>">

    <input type="hidden" id="section_sort_url" value="<?php echo e(route('sidebar-manager.sort-section', ['role_id' => $role->id])); ?>">
<?php $__env->stopSection(); ?>



<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Modules\MenuManage\Resources\views\role_index.blade.php ENDPATH**/ ?>