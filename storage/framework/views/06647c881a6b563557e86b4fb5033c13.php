...
<?php echo app('translator')->get('accounts.add_expense'); ?>
...
<section class="sms-breadcrumb mb-20">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('accounts.add_expense'); ?> </h1>
            <div class="bc-pages">
                <a href="<?php echo e(route('dashboard')); ?>"><?php echo app('translator')->get('common.dashboard'); ?> </a>
                <a href="#"><?php echo app('translator')->get('accounts.accounts'); ?></a>
                <a href="#"><?php echo app('translator')->get('accounts.add_expense'); ?></a>
            </div>
        </div>
    </div>
</section>
<section class="admin-visitor-area up_st_admin_visitor">
    <div class="container-fluid p-0">
        ...
        <?php if(userPermission("add-expense-store")): ?>
                       
        <div class="row">
            <div class="offset-lg-10 col-lg-2 text-right col-md-12 mb-20">
                <a href="<?php echo e(route('add-expense')); ?>" class="primary-btn small fix-gr-bg">
        ...
        <div class="row">
            <div class="col-lg-4 col-xl-3">
                <div class="row">
                    <div class="col-lg-12">
                        <?php if(isset($add_expense)): ?>
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true,  'route' => array('add-expense-update',@$add_expense->id), 'method' => 'PUT', 'enctype' => 'multipart/form-data' , 'id' => 'add-expense-update'])); ?>

                        <?php else: ?>
                        <?php if(userPermission("add-expense-store")): ?>
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'add-expense-store',
                        ...
                        <div class="white-box">
                            <div class="main-title">
                                ...
                                <h3 class="mb-15">
                                    <?php if(isset($add_expense)): ?>
                                        <?php echo app('translator')->get('accounts.edit_expense'); ?>
                                    <?php else: ?>
                                        <?php echo app('translator')->get('accounts.add_expense'); ?>
                                    <?php endif; ?>
                            ...
                            <div class="add-visitor">
                                <div class="row">
                                 ...
                                 <div class="row  mt-15">
                                    <div class="col-lg-12">
                                        ...
                                        <select class="primary_select  form-control<?php echo e(@$errors->has('expense_head') ? ' is-invalid' : ''); ?>" name="expense_head">
                                ...
                                <div class="row mt-15">
                                    <div class="col-lg-12">
                                        ...
                                        <select class="primary_select  form-control<?php echo e(@$errors->has('payment_method') ? ' is-invalid' : ''); ?>" name="payment_method" id="payment_method">
                                            ...
                                            <?php if(isset($add_expense)): ?>
                                            <option data-string="<?php echo e($payment_method->method); ?>" value="<?php echo e(@$payment_method->id); ?>"
                                                <?php echo e(@$add_expense->payment_method_id == @$payment_method->id? 'selected': ''); ?>><?php echo e(@$payment_method->method); ?></option>
                                            <?php else: ?>
                                                <option data-string="<?php echo e($payment_method->method); ?>" value="<?php echo e(@$payment_method->id); ?>" <?php echo e(old('payment_method') == @$payment_method->id? 'selected': ''); ?>><?php echo e(@$payment_method->method); ?></option>
                                            <?php endif; ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <select class="primary_select  form-control<?php echo e(@$errors->has('accounts') ? ' is-invalid' : ''); ?>" name="accounts">
                                            ...
                                            <option value="<?php echo e(@$bank_account->id); ?>"
                                                <?php echo e(@$add_expense->account_id == @$bank_account->id? 'selected': ''); ?>><?php echo e(@$bank_account->account_name); ?> (<?php echo e(@$bank_account->bank_name); ?>)</option>
                                            <?php else: ?>
                                        ...
                                        <div class="primary_input">
                                            ...
                                            <div class="primary_datepicker_input">
                                                <div class="no-gutters input-right-icon">
                                                    <div class="col">
                                                        <div class="">
                                                            <input class="primary_input_field  primary_input_field date form-control form-control<?php echo e(@$errors->has('date') ? ' is-invalid' : ''); ?>" id="startDate" type="text"
                                                            placeholder="<?php echo app('translator')->get('common.date'); ?> " name="date" value="<?php echo e(isset($add_expense)? date('m/d/Y',strtotime($add_expense->date)) : date('m/d/Y')); ?>">
                                                        </div>
                                                    </div>
                                ...
                                <div class="row  mt-15">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="primary_input">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('accounts.amount'); ?>  <span class="text-danger"> *</span></label>
                                            <input oninput="numberCheckWithDot(this)" class="primary_input_field form-control<?php echo e(@$errors->has('amount') ? ' is-invalid' : ''); ?>"
                                                type="text" name="amount" step="0.1" autocomplete="off" value="<?php echo e(isset($add_expense)? $add_expense->amount:old('amount')); ?>">
                                    ...
                                    <div class="col-lg-12 mt-15">
                                        <div class="primary_input">
                                            <div class="primary_file_uploader">
                                                <input class="primary_input_field" type="text" id="placeholderInput" placeholder="<?php echo e(isset($add_expense)? ($add_expense->file != ""? getFilePath3($add_expense->file): trans('common.file')) :  trans('common.file')); ?>"readonly
                                                >
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12">
                                        <div class="primary_input">
                                            ...
                                            <textarea class="primary_input_field form-control" cols="0" rows="4" name="description"><?php echo e(isset($add_expense)? $add_expense->description: old('description')); ?></textarea>
                                ...
                                <div class="row mt-40">
                                    <div class="col-lg-12 text-center">
                                       <button class="primary-btn fix-gr-bg submit" data-toggle="tooltip" title="<?php echo e($tooltip); ?>">
                                            ...
                                            <?php if(isset($add_expense)): ?>
                                                <?php echo app('translator')->get('accounts.update_expense'); ?>
                                            <?php else: ?>
                                                <?php echo app('translator')->get('accounts.save_expense'); ?>
                                            <?php endif; ?>
                ...
                <div class="white-box">
                    <div class="row">
                        <div class="col-lg-4 no-gutters">
                            <div class="main-title">
                                <h3 class="mb-15"><?php echo app('translator')->get('accounts.expense_list'); ?> </h3>
                            </div>
                        </div>
                    </div>
                            ...
                            <table id="table_id" class="table data-table" cellspacing="0" width="100%">
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th><?php echo app('translator')->get('accounts.a_c_Head'); ?> </th>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><?php echo app('translator')->get('accounts.delete_item'); ?> </h4>
            ...
            <div class="modal-body">
                ...
                <div class="mt-40 d-flex justify-content-between">
                    <button type="button" class="primary-btn tr-bg" data-dismiss="modal"><?php echo app('translator')->get('common.cancel'); ?> </button>
                     <?php echo e(Form::open(['route' => 'add-expense-delete', 'method' => 'POST', 'enctype' => 'multipart/form-data'])); ?>
...
<script type="text/javascript">
   ...
   $('.data-table').DataTable({
                 ...
                 "ajax": $.fn.dataTable.pipeline( {
                       url: "<?php echo e(route('ajaxExpenseList')); ?>",
                       data: { 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\backEnd\accounts\add_expense.blade.php ENDPATH**/ ?>