            ...
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php if(isset($subject)): ?>
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'global_subject_update', 'method' => 'POST'])); ?>

                        <?php else: ?>
                        <?php if(userPermission(258)): ?>
      
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'global_subject_store', 'method' => 'POST'])); ?>
                        ...
                        <div class="white-box">
                            <div class="add-visitor">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="primary_input">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('academics.subject_name'); ?> <span>*</span></label>
                                ...
                                <div class="row  mt-40">
                                    <div class="col-lg-12">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('academics.subject_code'); ?> <span>*</span></label>
                                ...
                                <?php if(@generalSetting()->result_type == 'mark'): ?>
                                    <div class="row  mt-40">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for=""><?php echo app('translator')->get('academics.pass_mark'); ?> <span>*</span></label>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mt-40 d-flex justify-content-between">
                                                        ...
                                                        <a href="<?php echo e(route('global_subject_delete', [@$subject->id])); ?>" class="text-light">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\backEnd\global\global_subject.blade.php ENDPATH**/ ?>