...
// Route::get('school/{school_id}/student-list', [SmApiController::class, 'saas_studentDetails']);
...
Route::group(['middleware' => ['XSS', 'auth:api', 'json.response'], 'as' => 'api.'], function () {
    ...
    Route::get('student-attendance-report', ['as' => 'student_attendance_report_api', 'uses' => 'api\ApiSmStudentAttendanceController@studentAttendanceReport']);
    ...
    Route::post('student-attendance-report-search', ['as' => 'student_attendance_report_search_api', 'uses' => 'api\ApiSmStudentAttendanceController@studentAttendanceReportSearch']);
    ...
    // Fees Group routes
    Route::get('sm-fees-group', ['as' => 'fees_group', 'uses' => 'api\ApiSmFeesGroupController@fees_group_index']);
    Route::get('school/{school_id}/sm-fees-group', ['as' => 'saas_fees_group', 'uses' => 'api\ApiSmFeesGroupController@saas_fees_group_index']);
    Route::get('fees-group-store', ['as' => 'fees_group_store', 'uses' => 'api\ApiSmFeesGroupController@fees_group_store']);
    Route::get('school/{school_id}/fees-group-store', ['as' => 'saas_fees_group_store', 'uses' => 'api\ApiSmFeesGroupController@saas_fees_group_store']);
    Route::get('fees-group-edit/{id}', ['as' => 'fees_group_edit', 'uses' => 'api\ApiSmFeesGroupController@fees_group_edit']);
    Route::get('school/{school_id}/sm-fees-group-edit/{id}', ['as' => 'saas_fees_group_edit', 'uses' => 'api\ApiSmFeesGroupController@saas_fees_group_edit']);
    Route::get('sm-fees-group-update', ['as' => 'fees_group_update', 'uses' => 'api\ApiSmFeesGroupController@fees_group_update']);
    Route::get('school/{school_id}/sm-fees-group-update', ['as' => 'saas_fees_group_update', 'uses' => 'api\ApiSmFeesGroupController@saas_fees_group_update']);
    Route::post('sm-fees-group-delete', ['as' => 'fees_group_delete', 'uses' => 'api\ApiSmFeesGroupController@fees_group_delete']);
    Route::post('school/{school_id}/sm-fees-group-delete', ['as' => 'saas_fees_group_delete', 'uses' => 'api\ApiSmFeesGroupController@saas_fees_group_delete']);
    ...
    // class routine new
    Route::get('class-routine-new', ['as' => 'class_routine_new_api', 'uses' => 'SmApiController@classRoutine']);
    ...
    Route::get('teacher-routine-view/{techer_id}/{school_id}', 'api\ApiSmClassRoutineController@saasTeacherClassRoutine');
    ...
    // Subject routes
    Route::get('subject', ['as' => 'subject_api', 'uses' => 'SmApiController@subject_index']);
    Route::get('library-subject', ['as' => 'library_subject', 'uses' => 'api\SmApiBookController@library_subject_index']);
    Route::get('school/{school_id}/subject', ['as' => 'saas_subject', 'uses' => 'SmApiController@saas_subject_index']);
    Route::post('subject-store', ['as' => 'subject_store_api', 'uses' => 'SmApiController@subject_store']);
    Route::post('saas-subject-store', ['as' => 'saas_subject_store', 'uses' => 'SmApiController@saas_subject_store']);
    Route::get('subject-edit/{id}', ['as' => 'subject_edit_api', 'uses' => 'SmApiController@subject_edit']);
    Route::get('school/{school_id}/subject-edit/{id}', ['as' => 'saas_subject_edit', 'uses' => 'SmApiController@saas_subject_edit']);
    Route::post('subject-update', ['as' => 'subject_update_api', 'uses' => 'SmApiController@subject_update']);
    Route::post('saas-subject-update', ['as' => 'saas_subject_update', 'uses' => 'SmApiController@saas_subject_update']);
    Route::get('subject-delete/{id}', ['as' => 'subject_delete_api', 'uses' => 'SmApiController@subject_delete']);
    Route::get('school/{school_id}/subject-delete/{id}', ['as' => 'saas_subject_delete', 'uses' => 'SmApiController@saas_subject_delete']);

    // Class route
    Route::get('class', ['as' => 'class_api', 'uses' => 'SmApiController@class_index']);
    Route::get('school/{school_id}/class', ['as' => 'saas_class', 'uses' => 'SmApiController@saas_class_index']);
    Route::post('class-store', ['as' => 'class_store_api', 'uses' => 'SmApiController@class_store']);
    Route::post('saas-class-store', ['as' => 'saas_class_store', 'uses' => 'SmApiController@saas_class_store']);
    Route::get('class-edit/{id}', ['as' => 'class_edit_api', 'uses' => 'SmApiController@class_edit']);
    Route::get('school/{school_id}/class-edit/{id}', ['as' => 'saas_class_edit', 'uses' => 'SmApiController@saas_class_edit']);
    Route::post('class-update', ['as' => 'class_update_api', 'uses' => 'SmApiController@class_update']);
    Route::post('saas-class-update', ['as' => 'saas_class_update', 'uses' => 'SmApiController@saas_class_update']);
    Route::get('class-delete/{id}', ['as' => 'class_delete_api', 'uses' => 'SmApiController@class_delete']);
    ...
    Route::get('section', ['as' => 'section_api', 'uses' => 'SmApiController@Section_index']);
    ...
    Route::post('section-store', ['as' => 'section_store_api', 'uses' => 'SmApiController@saas_Section_store']);
    Route::get('section-edit/{id}', ['as' => 'section_edit_api', 'uses' => 'SmApiController@Section_edit']);
    Route::get('school/{school_id}/section-edit/{id}', ['as' => 'saas_section_edit', 'uses' => 'SmApiController@saas_Section_edit']);
    Route::post('section-update', ['as' => 'section_update_api', 'uses' => 'SmApiController@Section_update']);
    Route::post('saas-section-update', ['as' => 'saas_section_update', 'uses' => 'SmApiController@saas_Section_update']);
    Route::get('section-delete/{id}', ['as' => 'section_delete_api', 'uses' => 'SmApiController@Section_delete']);
    ...
    Route::get('library-subject', ['as' => 'library_subject', 'uses' => 'api\ApiSmBookController@library_subject_index']);
    ...
    Route::post('student-exam-schedule', ['as' => 'student-exam-schedule-search', 'uses' => 'api\ApiSmExamRoutineController@studentExamRoutineSearch']);
    // exam routine report
    ...
    // Saas exam routine report
    Route::post('saas-exam-routine-report', ['as' => 'saas_exam_routine_report_post', 'uses' => 'api\ApiSmExamRoutineController@saasExamRoutineReportSearch']);
    ...
    Route::get('role', ['as' => 'role_api', 'uses' => 'SmApiController@role_index']);
    Route::post('role-store', ['as' => 'role_store_api', 'uses' => 'SmApiController@role_store']);
    Route::get('role-edit/{id}', ['as' => 'role_edit_api', 'uses' => 'SmApiController@role_edit']);
    Route::post('role-update', ['as' => 'role_update_api', 'uses' => 'SmApiController@role_update']);
    Route::post('role-delete', ['as' => 'role_delete_api', 'uses' => 'SmApiController@role_delete']);
    ...
    Route::post('class-section-subjectList', 'api\ApiSmStudentAttendanceController@subjectList');
    Route::post('student-subject-attendance-store', 'api\ApiSmStudentAttendanceController@studentSubjectAttendanceStore');
    Route::get('student-subject-attendance/{record_id}', 'api\ApiSmStudentAttendanceController@studentSubjectAttendanceSearch');
    Route::get('student-subject-attendance-check', 'api\ApiSmStudentAttendanceController@studentSubjectAttendanceCheck');

    Route::get('student-subject-attendance/{user_id}/{record_id}', 'api\ApiSmStudentAttendanceController@studentSubjectAttendanceSearch');

    Route::get('student-my-subject-attendance/{id}/{record_id}', 'api\ApiSmStudentAttendanceController@studentMySubjectAttendanceSearchAPI');
});
